...
<div class="ao3h-tab-content" data-tab="about">
    <div style="max-width: 600px; margin: 0 auto; padding: 16px;">
        ...
        <div style="padding: 14px; background: #f9f9f9; border-radius: 8px; margin-bottom: 16px;">
            <p style="color: #555; line-height: 1.6; font-size: 13px; margin: 0;">AO3 Helper enhances your Archive of Our Own experience with ${pt$1.length} modules across ${z$1.length} categories — covering reading, filtering, bookmarking, navigation, appearance, and more.</p>
        </div>

        <div style="display: flex; gap: 12px; margin-bottom: 16px;">
            <div style="flex: 1; padding: 12px; background: #fff5f5; border-radius: 8px; text-align: center;">
                <div style="font-size: 24px; font-weight: 700; color: #900;">${pt$1.length}</div>
    ...
    `}var w=Object.fromEntries([...z$1.map(e=>[e.id,C(e)]),[`about`,te()]]);console.log(`[AO3H][panel-tab-content] Tab content generated - ${z$1.length} tabs + About, ${pt$1.length} modules`);var T=`ficEngagement`,ne=`
...
`,Wt=`ao3h:rt:history`,Gt=`ao3h:rt:excludedWorks`;function Kt(){try{return JSON.parse(localStorage.getItem(Wt)||`[]`)}catch(e){return []}}function qt(e){try{localStorage.setItem(Wt,JSON.stringify(e));}catch(e){}}function Jt(){try{return JSON.parse(localStorage.getItem(Gt)||`[]`)}catch(e){return []}}function Yt(e){try{localStorage.setItem(Gt,JSON.stringify(e));}catch(e){}}function J(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Xt(e){if(!e)return ``;let t=Math.round((Date.now()-e)/864e5);return t<=0?`today`:t===1?`yesterday`:t<30?`${t} days ago`:new Date(e).toLocaleDateString(`en-US`,{year:`numeric`,month:`short`,day:`numeric`})}function Zt(e){let t=new Date(Date.now());t.setHours(0,0,0,0);let n=t.getTime(),r=n-864e5,i=n-7*864e5,a={Today:[],Yesterday:[],"This week":[],Older:[]};for(let t of e){let e=t.lastReadAt||t.seenAt||0;e>=n?a.Today.push(t):e>=r?a.Yesterday.push(t):e>=i?a[`This week`].push(t):a.Older.push(t);}return a}function Qt(e){let t=e.lastReadAt||e.seenAt;return `
    ...
    </li>`).join(``),t.querySelectorAll(`.ao3h-rt-exclusion-remove`).forEach(t=>{t.addEventListener(`click`,()=>{Yt(Jt().filter(e=>e!==t.dataset.value)),en();});});}function tn(e){let t=e.querySelector(`#ao3h-rt-history-list`);if(t&&!t.dataset.wired){var r,i,a;t.dataset.wired=`1`;let o=()=>$t(t);(r=e.querySelector(`#ao3h-rt-search`))==null||r.addEventListener(`input`,o),(i=e.querySelector(`#ao3h-rt-sort`))==null||i.addEventListener(`change`,o),(a=e.querySelector(`#ao3h-rt-group-period`))==null||a.addEventListener(`change`,o),t.addEventListener(`click`,e=>{var t;let r=e.target.closest(`[data-action="rt-pin"]`),i=e.target.closest(`[data-action="rt-note"]`),a=e.target.closest(`[data-action="delete-entry"]`),s=(t=e.target.closest(`.ao3h-rt-history-entry`))==null?void 0:t.dataset.id;if(s)if(r)qt(Kt().map(e=>e.id===s?d$1(d$1({},e),{},{pinned:!e.pinned}):e)),o();else if(i){let e=Kt(),t=e.find(e=>e.id===s),r=window.prompt(`Personal note for this entry:`,(t==null?void 0:t.note)||``);if(r===null)return;qt(e.map(e=>e.id===s?d$1(d$1({},e),{},{note:r.trim()||void 0}):e)),o();}else a&&(qt(Kt().filter(e=>e.id!==s)),o());}),o();}let o=e.querySelector(`[data-action="rt-cleanup"]`);o&&!o.dataset.wired&&(o.dataset.wired=`1`,o.addEventListener(`click`,()=>{var n;let r=parseInt((n=e.querySelector(`#ao3h-rt-cleanup-days`))==null?void 0:n.value,10);if(!r||r<=0){window.alert(`Enter a number of days first.`);return}let i=Date.now()-r*864e5,a=Kt(),o=a.filter(e=>e.pinned||(e.lastReadAt||e.seenAt||0)>=i),s=a.length-o.length;qt(o),t&&$t(t),window.alert(`Removed ${s} entr${s===1?`y`:`ies`} older than ${r} days (pinned entries kept).`);}));let s=e.querySelector(`[data-action="rt-add-exclusion"]`);s&&!s.dataset.wired&&(s.dataset.wired=`1`,en(),s.addEventListener(`click`,()=>{let t=e.querySelector(`#ao3h-rt-exclude-input`),n=t==null?void 0:t.value.trim();if(!n)return;let r=/^\d+$/.test(n)?n:`fandom:${n}`,i=Jt();i.includes(r)||Yt([...i,r]),t.value=``,en();}));}document.addEventListener(`ao3h:configOpen`,function(e){var t;((t=e.detail)==null?void 0:t.moduleId)===`readingTracker`&&tn(e.target);});var nn=`textToSpeech`,rn=`
...
`,nr=`ao3h:laterShelf:items`,rr=`ao3h:laterShelf:archive`,ir=`ao3h:laterShelf:reminders`,ar=`ao3h:laterShelf:reminders:history`,or=`ao3h:rt:history`,sr=`ao3h:ficAppreciation:status`;function Y(e,t){try{let n=JSON.parse(localStorage.getItem(e)||`null`);return n==null?t:n}catch(e){return t}}function cr(e,t){try{localStorage.setItem(e,JSON.stringify(t));}catch(e){}}function X(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function lr(){let e=Y(nr,[]);return Array.isArray(e)?e:[]}function ur(e){cr(nr,e);}function dr(){let e=Y(rr,[]);return Array.isArray(e)?e:[]}function fr(e){cr(rr,e);}function pr(){let e=Y(ir,{});return e&&typeof e==`object`?e:{}}function mr(){let e=Y(ar,[]);return Array.isArray(e)?e:[]}function hr(){let e=Y(or,[]);return Array.isArray(e)?e:[]}function gr(){let e=Y(sr,{});return e&&typeof e==`object`?e:{}}function _r(e){let t=lr(),n={};t.forEach(e=>{e.group&&(n[e.group]=(n[e.group]||0)+1);});let r=Object.keys(n).sort();if(!r.length){e.innerHTML=`<p class="ao3h-ls-cfg-empty">No groups yet — assign one from the MFL page.</p>`;return}e.innerHTML=r.map(e=>`
    <div class="ao3h-ls-cfg-row" data-group="${X(e)}">
      <span>${X(e)} (${n[e]})</span>
      <button type="button" data-action="ls-rename-group" data-group="${X(e)}">Rename</button>
      <button type="button" data-action="ls-clear-group" data-group="${X(e)}">Clear</button>
    </div>`).join(``);}function vr(e){e.addEventListener(`click`,t=>{let r=t.target.closest(`[data-action="ls-rename-group"]`),i=t.target.closest(`[data-action="ls-clear-group"]`);if(r){let t=r.dataset.group,i=window.prompt(`Rename group "${t}" to:`,t);if(i===null||!i.trim()||i.trim()===t)return;ur(lr().map(e=>e.group===t?d$1(d$1({},e),{},{group:i.trim()}):e)),_r(e);}else if(i){let t=i.dataset.group;if(!window.confirm(`Remove the "${t}" group from all its fics? (the fics themselves stay on the shelf)`))return;ur(lr().map(e=>e.group===t?d$1(d$1({},e),{},{group:``}):e)),_r(e);}});}function yr(e){let t=dr();if(!t.length){e.innerHTML=`<p class="ao3h-ls-cfg-empty">No removed fics yet.</p>`;return}e.innerHTML=t.slice(0,50).map(e=>`
    <div class="ao3h-ls-cfg-row" data-wid="${X(e.wid)}">
      <a href="https://archiveofourown.org/works/${X(e.wid)}" target="_blank" rel="noopener">${X(e.title||`Work ${e.wid}`)}</a>
      <span class="ao3h-ls-cfg-meta">removed ${e.removedAt?new Date(e.removedAt).toLocaleDateString():``}</span>
      <button type="button" data-action="ls-restore" data-wid="${X(e.wid)}">↩ Restore</button>
      <button type="button" data-action="ls-forget" data-wid="${X(e.wid)}">🗑 Delete forever</button>
    </div>`).join(``);}function br(e){e.addEventListener(`click`,t=>{var r;let i=t.target.closest(`[data-action="ls-restore"]`),a=t.target.closest(`[data-action="ls-forget"]`),o=(r=i||a)==null?void 0:r.dataset.wid;if(!o)return;let s=dr(),c=s.findIndex(e=>String(e.wid)===String(o));if(c===-1)return;let[l]=s.splice(c,1);if(fr(s),i){let{removedAt:e}=l,t=t$1(l,$n),r=lr();r.some(e=>String(e.wid)===String(o))||(r.push(d$1(d$1({},t),{},{addedAt:Date.now(),order:Date.now()})),ur(r));}yr(e);});}var xr={fired:`🔔 Fired`,cancelled:`✕ Cancelled`,snoozed:`💤 Snoozed`};function Sr(e){let t=mr();if(!t.length){e.innerHTML=`<p class="ao3h-ls-cfg-empty">No reminder activity yet.</p>`;return}e.innerHTML=t.slice(0,50).map(e=>`
    <div class="ao3h-ls-cfg-row">
      <span>${xr[e.action]||e.action}</span>
      <a href="https://archiveofourown.org/works/${X(e.wid)}" target="_blank" rel="noopener">${X(e.title||`Work ${e.wid}`)}</a>
      ${e.special?`<span class="ao3h-ls-cfg-meta">(${X(e.special)})</span>`:``}
    ...
    <div class="ao3h-ls-cfg-row" data-wid="${X(e.id)}" data-title="${X(e.title||``)}">
      <a href="${X(e.href||`/works/${e.id}`)}" target="_blank" rel="noopener">${X(e.title||`Work ${e.id}`)}</a>
...
`,Yr=`ao3h:backupAndSync:backups`;function Xr(){var e;let t=(e=window.AO3H)==null?void 0:e.backupAndSync;if(t)return t.getBackups();try{let e=JSON.parse(localStorage.getItem(Yr)||`[]`);return Array.isArray(e)?e:[]}catch(e){return []}}function Zr(e){try{localStorage.setItem(Yr,JSON.stringify(e));}catch(e){}}function Qr(){return $r.apply(this,arguments)}function $r(){return $r=t(function*({mode:e=`standard`,categories:t=[]}={}){var n;let r=(n=window.AO3H)==null?void 0:n.backupAndSync;if(!r)return alert(`Enable the Backup & Sync module to create backups.`),null;if(e===`encrypted`){let e=prompt(`Password for this encrypted backup:`);return e?r.createEncryptedBackup(e):null}return e===`compressed`?r.createCompressedBackup():e===`incremental`?r.createIncrementalBackup():t.length?r.createSelectiveBackup(t):r.createBackup()}),$r.apply(this,arguments)}function ei(e,t){let n=new Blob([JSON.stringify(e,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,i.click(),URL.revokeObjectURL(r);}function ti(e){return e<1024?`${e} B`:`${(e/1024).toFixed(1)} KB`}function ni(t$1){let n=t$1.querySelector(`#ao3h-bas-list`),r=t$1.querySelector(`#ao3h-bas-search`);if(!n)return;function i(){var e;let n=parseInt((e=t$1.querySelector(`[data-setting="maxBackups"]`))==null?void 0:e.value,10);return Number.isFinite(n)&&n>0?n:10}function a(){let t$1=Xr(),i=((r==null?void 0:r.value)||``).trim(),o=t$1.map((e,t)=>({b:e,idx:t})).filter(({b:e})=>Vr(e,i));if(n.innerHTML=``,!t$1.length){let e=document.createElement(`div`);e.className=`ao3h-bas-empty`,e.textContent=`No backups yet — click "Backup Now" to create one.`,n.appendChild(e);return}if(!o.length){let e=document.createElement(`div`);e.className=`ao3h-bas-empty`,e.textContent=`No backups match your search.`,n.appendChild(e);return}o.forEach(({b:t$1,idx:r})=>{let i=document.createElement(`div`);i.className=`ao3h-bas-row`;let o=Ir(t$1),s=document.createElement(`span`);s.className=`ao3h-bas-row-status`;let c=e=>{s.textContent=e.valid?`✓`:`⚠️`,s.classList.toggle(`ao3h-bas-row-status--bad`,!e.valid),s.title=e.valid?`Backup is valid and restorable`:`Corrupt backup: ${e.reason}`;};c(o),o.valid&&o.type===`compressed`&&Lr(t$1).then(e=>{s.isConnected&&c(e);});let l=document.createElement(`div`);l.className=`ao3h-bas-row-info`;let u=new Blob([JSON.stringify(t$1)]).size,d=Br(t$1),f=[zr(o.type)];d!==null&&f.push(`${d} keys`),f.push(ti(u)),l.textContent=`${new Date(t$1.timestamp).toLocaleString()} — ${f.join(`, `)}`;let p=document.createElement(`div`);p.className=`ao3h-bas-row-actions`;let m=document.createElement(`button`);m.type=`button`,m.className=`ao3h-config-action-btn ao3h-inline-btn`,m.textContent=`Restore`,m.addEventListener(`click`,t(function*(){var e;let n=new Date(t$1.timestamp).toLocaleString();if(!Ir(t$1).valid){alert(`This backup is corrupt (${Ir(t$1).reason}) and cannot be restored.`);return}let i=(e=window.AO3H)==null?void 0:e.backupAndSync;if(!i){alert(`Enable the Backup & Sync module to restore backups.`);return}let a=Fr(t$1),o;if(a===`incremental`)o=yield i.restoreIncrementalBackup(r);else if(a===`encrypted`){let e=prompt(`Password for the encrypted backup from ${n}:`);if(!e)return;if(o=yield i.restoreEncryptedBackup(r,e),!o){alert(`Decryption failed — wrong password or corrupt backup.`);return}}else if(a===`compressed`){if(o=yield i.restoreCompressedBackup(r),!o){alert(`This compressed backup could not be read.`);return}}else o=i.restoreBackup(r);o&&(m.textContent=`✓ Restored`,setTimeout(()=>{m.textContent=`Restore`;},1500));}));let h=document.createElement(`button`);h.type=`button`,h.className=`ao3h-config-action-btn ao3h-inline-btn ao3h-inline-btn--danger`,h.textContent=`🗑️`,h.title=`Delete this backup`,h.addEventListener(`click`,()=>{let e=Xr();e.splice(r,1),Zr(e),a();}),p.append(m,h),i.append(s,l,p),n.appendChild(i);});}if(r&&!r.dataset.wired){r.dataset.wired=`1`;let e=0;r.addEventListener(`input`,()=>{clearTimeout(e),e=setTimeout(a,150);});}let o=t$1.querySelector(`[data-action="backup-now"]`);o&&!o.dataset.wired&&(o.dataset.wired=`1`,o.addEventListener(`click`,t(function*(){var e,n;(yield Qr({mode:((e=t$1.querySelector(`#ao3h-bas-mode`))==null?void 0:e.value)||`standard`,categories:Hr((n=t$1.querySelector(`#ao3h-bas-categories`))==null?void 0:n.value)}))&&(a(),o.textContent=`✓ Backed Up`,setTimeout(()=>{o.textContent=`☁️ Backup Now`;},1500));})));let s=t$1.querySelector(`[data-action="export-backup"]`);s&&!s.dataset.wired&&(s.dataset.wired=`1`,s.addEventListener(`click`,()=>{let e=Xr();if(!e.length){alert(`No backups to export yet.`);return}ei(e,`ao3h-backups-${new Date().toISOString().replace(/[:.]/g,`-`)}.json`);}));let c=t$1.querySelector(`[data-action="import-backup"]`);c&&!c.dataset.wired&&(c.dataset.wired=`1`,c.addEventListener(`click`,()=>{let e=document.createElement(`input`);e.type=`file`,e.accept=`.json,application/json`,e.addEventListener(`change`,()=>{var t;let n=(t=e.files)==null?void 0:t[0];if(!n)return;let r=new FileReader;r.onload=()=>{try{let e=JSON.parse(String(r.result));if(!Array.isArray(e))throw Error(`Expected an array of backups.`);let t=e.filter(e=>Ir(e).valid);if(!t.length)throw Error(`No valid backups found in file.`);let n=Xr(),o=n.concat(t).sort((e,t)=>new Date(t.timestamp).getTime()-new Date(e.timestamp).getTime()).slice(0,i());n.length=0,n.push(...o),Zr(n),a(),c.textContent=`✓ Imported ${t.length}`,setTimeout(()=>{c.textContent=`Import`;},1500);}catch(e){alert(`Import failed: `+((e==null?void 0:e.message)||`invalid file`));}},r.readAsText(n);}),e.click();}));let l=t$1.querySelector(`[data-action="clear-all-backups"]`);l&&!l.dataset.wired&&(l.dataset.wired=`1`,l.addEventListener(`click`,()=>{let e=Xr();e.length&&confirm(`Delete all backups? This cannot be undone.`)&&(e.length=0,Zr(e),a());})),a();}var ri=`ao3h:OfflineReading:library`,ii=4*1024*1024;function ai(e=localStorage){try{let t=JSON.parse(e.getItem(`ao3h:OfflineReading:library`)||`{}`);return t&&typeof t==`object`&&!Array.isArray(t)?t:{}}catch(e){return {}}}function oi(e){return !Number.isFinite(e)||e<0?`0 B`:e<1024?`${Math.round(e)} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/(1024*1024)).toFixed(1)} MB`}function si(e){try{return JSON.stringify(e||{}).length*2}catch(e){return 0}}function ci(e){return Object.entries(e||{}).map(([e,t])=>{let n=si(t);return {workId:e,title:(t==null?void 0:t.title)||`Work ${e}`,author:(t==null?void 0:t.author)||`Anonymous`,date:(t==null?void 0:t.date)||0,dateLabel:t!=null&&t.date?new Date(t.date).toLocaleString():`—`,sizeLabel:oi(n),bytes:n}}).sort((e,t)=>t.date-e.date)}function li(e,t=ii){let n=0,r=Object.values(e||{});for(let e of r)n+=si(e);return {count:r.length,bytes:n,label:`${r.length} work${r.length===1?``:`s`} — ${oi(n)}`,warn:n>=t}}function ui(e,t=localStorage){let n=ai(t);delete n[e];try{t.setItem(ri,JSON.stringify(n));}catch(e){}return n}function di(e=localStorage){try{e.setItem(ri,`{}`);}catch(e){}return {}}var fi=`ficDownloader`,pi=`
...
`;function mi(e,t,n){let r=e.querySelector(t),i=e.querySelector(n);!r||!i||r.dataset.wired||(r.dataset.wired=`1`,i.style.display=r.checked?``:`none`,r.addEventListener(`change`,()=>{i.style.display=r.checked?``:`none`;}));}function hi(e){if(!(e!=null&&e.html)||typeof URL.createObjectURL!=`function`)return;let t=new Blob([e.html],{type:`text/html;charset=utf-8`}),n=URL.createObjectURL(t);window.open(n,`_blank`)?setTimeout(()=>URL.revokeObjectURL(n),1e4):URL.revokeObjectURL(n);}function gi(e){let t=e.querySelector(`#ao3h-dl-offline-list`),n=e.querySelector(`#ao3h-dl-offline-total`),r=e.querySelector(`#ao3h-dl-offline-search`);if(!t)return;function i(){let e=ai(),a=((r==null?void 0:r.value)||``).trim().toLowerCase(),o=ci(e).filter(e=>!a||e.title.toLowerCase().includes(a)||e.author.toLowerCase().includes(a)),s=li(e);if(n&&(n.textContent=s.count?`${s.label}${s.warn?` — ⚠️ close to the browser storage limit`:``}`:``,n.classList.toggle(`ao3h-dl-offline-total--warn`,s.warn)),t.innerHTML=``,!o.length){let e=document.createElement(`div`);e.className=`ao3h-dl-offline-empty`,e.textContent=s.count?`No offline works match your search.`:`No works saved offline yet — use "📥 Save Offline" on a work page.`,t.appendChild(e);return}o.forEach(e=>{let n=document.createElement(`div`);n.className=`ao3h-dl-offline-row`;let r=document.createElement(`div`);r.className=`ao3h-dl-offline-row-info`,r.textContent=`${e.title} — ${e.author} (${e.dateLabel}, ${e.sizeLabel})`,r.title=`Work ${e.workId}`;let a=document.createElement(`div`);a.className=`ao3h-dl-offline-row-actions`;let o=document.createElement(`button`);o.type=`button`,o.className=`ao3h-config-action-btn ao3h-inline-btn`,o.textContent=`📖 Read`,o.title=`Open the cached copy in a new tab`,o.addEventListener(`click`,()=>{hi(ai()[e.workId]);});let s=document.createElement(`button`);s.type=`button`,s.className=`ao3h-config-action-btn ao3h-inline-btn ao3h-inline-btn--danger`,s.textContent=`🗑️`,s.title=`Remove from offline library`,s.addEventListener(`click`,()=>{ui(e.workId),i();}),a.append(o,s),n.append(r,a),t.appendChild(n);});}if(r&&!r.dataset.wired){r.dataset.wired=`1`;let e=0;r.addEventListener(`input`,()=>{clearTimeout(e),e=setTimeout(i,150);});}let a=e.querySelector(`[data-action="clear-offline-library"]`);a&&!a.dataset.wired&&(a.dataset.wired=`1`,a.addEventListener(`click`,()=>{li(ai()).count&&confirm(`Remove all works saved offline? This cannot be undone.`)&&(di(),i());})),i();}function _i(e){mi(e,`#ao3h-dl-kindle`,`#ao3h-dl-kindle-opts`),mi(e,`#ao3h-dl-calibre`,`#ao3h-dl-calibre-opts`),gi(e);}var vi=`themeBuilder`,yi=`
...
`},Ci={[Si.moduleId]:Si.config,[T]:ne,[re]:E,[ue]:de,[Re]:ze,[Ve]:He,[pt]:mt,[Mt]:Nt,[Pt]:Ft,[It]:Lt,[Rt]:zt,[Bt]:Vt,[Ht]:Ut,[nn]:rn,[an]:on,[sn]:cn,[ln]:un,[dn]:pn,[hn]:gn,[Sn]:Cn,[wn]:Tn,[En]:Dn,[On]:kn,[An]:jn,[Nn]:Pn,[Rn]:zn,[Hn]:Un,[Wn]:Gn,[Kn]:qn,[Yn]:Xn,[Zn]:Qn,[er]:tr,[Dr]:Or,[kr]:Ar,[jr]:Mr,[qr]:Jr,[fi]:pi,[vi]:yi,[bi]:xi};function wi(e){return Ci[e]||Ci._default}function Ti(){return Object.keys(Ci).filter(e=>e!==`_default`&&typeof Ci[e]==`string`)}var Z={};typeof N==`function`&&(Z[re]=N),typeof Le==`function`&&(Z[ue]=Le),typeof ni==`function`&&(Z[qr]=ni),typeof _i==`function`&&(Z[fi]=_i),typeof Jn==`function`&&(Z[Kn]=Jn),typeof Vn==`function`&&(Z[Rn]=Vn),typeof mn==`function`&&(Z[dn]=mn),typeof xn==`function`&&(Z[hn]=xn),typeof Mn==`function`&&(Z[An]=Mn),typeof tn==`function`&&(Z[Ht]=tn),typeof Er==`function`&&(Z[er]=Er);function Ei(e,t){let n=Z[e];typeof n==`function`&&n(t);}console.log(`[AO3H][panel-configs] Panel configs index loaded - `+Ti().length+` modules registered`);var Di=typeof unsafeWindow<`u`?unsafeWindow:window,Q={pendingSaves:0,dirty:false,_savedTimer:null};function Oi(){return (pt$1==null?void 0:pt$1.length)||0}function ki(){var e,t,n,r,i,a;let o=((e=window.AO3H)==null?void 0:e.flags)||((t=Di.AO3H)==null?void 0:t.flags),s=((n=window.AO3H)==null||(n=n.modules)==null||(r=n.all)==null?void 0:r.call(n))||((i=Di.AO3H)==null||(i=i.modules)==null||(a=i.all)==null?void 0:a.call(i))||[];return !o||typeof o.get!=`function`||!s.length?s.filter(e=>e==null?void 0:e._booted).length:s.reduce((e,t)=>{var n;let r=(t==null?void 0:t.enabledKey)||`mod:${t==null?void 0:t.name}:enabled`,i=!!(!(t==null||(n=t.meta)==null)&&n.enabledByDefault);return e+ +!!o.get(r,i)},0)}function $(){let e=document.getElementById(`ao3h-panel-footer-status`);e&&(e.innerHTML=`<strong>${ki()}</strong> enabled · ${Oi()} modules total · ${Q.dirty?`<span class="ao3h-footer-unsaved">Unsaved changes</span>`:`All changes saved`}`);}function Ai(){Q.pendingSaves+=1,Q.dirty=true,clearTimeout(Q._savedTimer),$();}function ji(e){if(Q.pendingSaves>0&&--Q.pendingSaves,e===false){Q.dirty=true,$();return}clearTimeout(Q._savedTimer),Q._savedTimer=setTimeout(()=>{Q.pendingSaves===0&&(Q.dirty=false),$();},1500);}function Mi(){document.querySelectorAll(`[data-config-module]`).forEach(e=>{let t=e.dataset.configModule,n=wi(t);(e.innerHTML=n,Ei(t,e));});}function Ni(e,t){e.addEventListener(`click`,x),t.querySelectorAll(`.${b}-panel-close, .ao3h-footer-close`).forEach(e=>{e.addEventListener(`click`,x);});let n=function(e){e.key===`Escape`&&(x(),document.removeEventListener(`keydown`,n));};document.addEventListener(`keydown`,n),console.log(`[AO3H][tab-system] ✅ Close handlers attached`);}function Pi(e,t){var n;let r=e.closest(`.${b}-panel-body`),i=r==null||(n=r.parentElement)==null?void 0:n.querySelector(`.${b}-bulk-actions`);i&&i.remove();let a=document.createElement(`div`);a.className=`${b}-bulk-actions`,a.innerHTML=`
    ...
    `,r!=null&&r.parentElement&&(r.parentElement.appendChild(a),a.querySelector(`.ao3h-footer-save-close`).addEventListener(`click`,zi)),$();let o=r==null?void 0:r.closest(`.${b}-panel-box`);o==null||o.querySelectorAll(`.ao3h-bulk-actions-buttons .ao3h-panel-action-btn[data-action]`).forEach(t=>{let n=t.cloneNode(true);t.replaceWith(n),n.addEventListener(`click`,function(){let t=this.getAttribute(`data-action`),n=e.querySelectorAll(`.ao3h-quick-enable-checkbox`),r=t===`enable-all`;n.forEach(e=>{e.checked=r,e.dispatchEvent(new Event(`change`,{bubbles:true}));}),console.log(`[AO3H][tab-system] ${t}: ${n.length} modules`);});}),console.log(`[AO3H][tab-system] ✅ Bulk actions setup for tab:`,t);}function Fi(e){e.querySelectorAll(`.ao3h-picker-row`).forEach(e=>{let t=e.querySelector(`.ao3h-picker`),n=e.querySelector(`[data-action^="add"]`),r=e.parentElement.querySelector(`.ao3h-chip-container`);if(!t||!n||!r)return;let i=t.dataset.pickerType||`item`,a=[];try{let e=r.dataset.value;e&&(a=JSON.parse(e));}catch(e){}function o(){r.innerHTML=``,a.forEach(e=>{let n=t.querySelector(`option[value="${e}"]`);c(e,n?n.textContent:e,false);}),s();}function s(){r.dataset.value=JSON.stringify(a),r.dispatchEvent(new CustomEvent(`chipsChanged`,{detail:{type:i,items:a},bubbles:true}));}function c(e,t,n=true){n&&!a.includes(e)&&a.push(e);let o=document.createElement(`span`);o.className=`ao3h-chip`,o.dataset.value=e,o.innerHTML=`${t} <button type="button" title="Remove ${t}" aria-label="Remove ${t}">×</button>`,o.querySelector(`button`).addEventListener(`click`,()=>{o.remove(),a=a.filter(t=>t!==e),s(),console.log(`[AO3H][chip-picker:${i}] Removed:`,e);}),r.appendChild(o);}function l(){var e;let n=t.value;if(!n)return;let r=(e=t.options[t.selectedIndex])==null?void 0:e.text;if(a.includes(n)){console.log(`[AO3H][chip-picker:${i}] Already added:`,n);return}c(n,r,true),s(),t.selectedIndex=0,console.log(`[AO3H][chip-picker:${i}] Added:`,n,`| Total:`,a.length);}n.addEventListener(`click`,l),t.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),l());}),o(),console.log(`[AO3H][tab-system] ✅ Chip picker setup (${i})`);});}function Ii(e){e.querySelectorAll(`.ao3h-config-reset-btn`).forEach(e=>{let t=null,n=e.textContent.trim(),r=e.dataset.fullReset===`true`;e.addEventListener(`click`,function(){if(this.classList.contains(`ao3h-reset-confirming`))if(clearTimeout(t),this.classList.remove(`ao3h-reset-confirming`),this.textContent=n,r){try{Object.keys(localStorage).filter(e=>e.startsWith(`ao3h`)).forEach(e=>localStorage.removeItem(e));}catch(e){}location.reload();}else {let e=this.closest(`.ao3h-module-config-area`);e&&e.querySelectorAll(`input, select, textarea`).forEach(e=>{e.type===`checkbox`||e.type===`radio`?e.checked=e.defaultChecked:e.tagName===`SELECT`?Array.from(e.options).forEach(e=>{e.selected=e.defaultSelected;}):e.value=e.defaultValue,e.dispatchEvent(new Event(`change`,{bubbles:true}));}),console.log(`[AO3H][tab-system] Module reset confirmed`);}else this.classList.add(`ao3h-reset-confirming`),this.textContent=r?`⚠ Reset everything?`:`⚠ Confirm reset?`,t=setTimeout(()=>{this.classList.remove(`ao3h-reset-confirming`),this.textContent=n;},3e3);});});}function Li(e){return Ri.apply(this,arguments)}function Ri(){return Ri=t(function*(e){var t,n;let r=e.dataset.configModule;if(!r)return;let i=e.querySelectorAll(`[data-setting]`),o={},s=new Set;i.forEach(t=>{let n=t.dataset.setting;if(n)if(t.type===`checkbox`)o[n]=t.checked;else if(t.type===`radio`){if(!s.has(n)){s.add(n);let t=e.querySelector(`input[type="radio"][data-setting="${n}"]:checked`);t&&(o[n]=t.value);}}else o[n]=t.value;});let c=((t=window.AO3H)==null?void 0:t.settings)||((n=Di.AO3H)==null?void 0:n.settings);if(c)yield c.set(r,o);else {let e=`ao3h:mod:${r}:settings`,t=JSON.parse(localStorage.getItem(e)||`{}`);localStorage.setItem(e,JSON.stringify(Object.assign({},t,o)));}document.dispatchEvent(new CustomEvent(y$1,{bubbles:false,detail:{moduleId:r,settings:o}}));}),Ri.apply(this,arguments)}function zi(){return Bi.apply(this,arguments)}function Bi(){return Bi=t(function*(){let e=document.querySelectorAll(`.ao3h-module-config-area`);for(let t of e)try{yield Li(t);}catch(e){console.error(`[AO3H][tab-system] Save failed for`,t.dataset.configModule,e);}Q.dirty=false,Q.pendingSaves=0,x();}),Bi.apply(this,arguments)}function Vi(e){e.querySelectorAll(`[data-config-module]`).forEach(e=>{let t=e.dataset.configModule;if(t)try{let n=localStorage.getItem(`ao3h:mod:${t}:settings`);if(!n)return;let r=JSON.parse(n);e.querySelectorAll(`[data-setting]`).forEach(e=>{let t=e.dataset.setting;t in r&&(e.type===`checkbox`?e.checked=!!r[t]:e.type===`radio`?e.checked=e.value===r[t]:e.value=r[t]);});}catch(e){}});}function Hi(e){e.querySelectorAll(`.ao3h-module-config-area`).forEach(e=>{e.dataset.autoSaveWired||(e.dataset.autoSaveWired=`1`,e.addEventListener(`change`,e=>{e.target.closest(`[data-setting]`)&&(Q.dirty=true,clearTimeout(Q._savedTimer),$());}));});}function Ui(t$1){t$1.querySelectorAll(`.ao3h-config-save-btn`).forEach(t$1=>{t$1.addEventListener(`click`,t(function*(){let e=this.closest(`.ao3h-module-config-area`);if(!e||!e.dataset.configModule)return;Ai();try{yield Li(e),ji(!0);}catch(t){ji(false),console.error(`[AO3H][tab-system] Save failed for`,e.dataset.configModule,t);return}let t=this.textContent;this.textContent=`✓ Saved`,this.classList.add(`ao3h-save-success`),setTimeout(()=>{this.textContent=t,this.classList.remove(`ao3h-save-success`);},1500);}));});}function Wi(e){e.querySelectorAll(`.ao3h-config-btn`).forEach(e=>{e.setAttribute(`aria-label`,`Module settings`),e.setAttribute(`aria-expanded`,`false`),e.addEventListener(`click`,function(e){e.stopPropagation();let t=this.closest(`.ao3h-module-container`),n=t.querySelector(`.ao3h-module-config-area`);if(n){let e=n.classList.contains(`ao3h-expanded`);if(n.classList.toggle(`ao3h-expanded`),this.textContent=e?`▼`:`▲`,this.setAttribute(`aria-expanded`,e?`false`:`true`),!e){let e=t.dataset.moduleId;Ei(e,n),n.dispatchEvent(new CustomEvent(`ao3h:configOpen`,{bubbles:true,detail:{moduleId:e,configArea:n}})),setTimeout(()=>{typeof window.AO3H_wireHelpButtons==`function`&&window.AO3H_wireHelpButtons(n);},0),setTimeout(()=>{let e=document.querySelector(`#ao3h-tab-container`);if(!e)return;let n=t.getBoundingClientRect(),r=e.getBoundingClientRect(),i=n.top-r.top;Math.abs(i)>5&&e.scrollBy({top:i,behavior:`smooth`});},450);}console.log(`[AO3H][tab-system] Config toggled:`,e?`closed`:`opened`);}});});}function Gi(t$1){t$1.querySelectorAll(`.ao3h-module-row`).forEach(t$1=>{let n=t$1.closest(`.ao3h-module-container`),r=n==null?void 0:n.dataset.moduleId,i=t$1.querySelector(`.ao3h-quick-enable-checkbox`);if(i&&r){var a,o,s,c,l,u,d;let n=((a=t$1.querySelector(`.ao3h-module-name`))==null||(a=a.textContent)==null?void 0:a.trim())||r;i.setAttribute(`aria-label`,`Enable ${n}`);let f=((o=window.AO3H)==null?void 0:o.flags)||((s=Di.AO3H)==null?void 0:s.flags),p=(c=window.AO3H)==null?void 0:c.modules,m=p==null||(l=p.all)==null||(l=l.call(p))==null||(u=l.find)==null?void 0:u.call(l,e=>e.name===r),h=!!(!(m==null||(d=m.meta)==null)&&d.enabledByDefault);i.checked=f?!!f.get(`mod:${r}:enabled`,h):h,i.addEventListener(`change`,t(function*(){if(r){try{var e,t;let n=((e=Di.AO3H)==null?void 0:e.modules)||((t=window.AO3H)==null?void 0:t.modules);n!=null&&n.setEnabled&&(yield n.setEnabled(r,this.checked)),$();}catch(e){console.error(`[AO3H][tab-system] setEnabled failed for`,r,e);}document.dispatchEvent(new CustomEvent(`ao3h:flags-updated`,{detail:{key:`mod:${r}:enabled`,value:this.checked}})),console.log(`[AO3H][tab-system]`,r,this.checked?`enabled`:`disabled`);}})),document.addEventListener(`ao3h:flags-updated`,function(e){var t;((t=e.detail)==null?void 0:t.key)===`mod:${r}:enabled`&&(i.checked=!!e.detail.value);});}t$1.addEventListener(`click`,function(e){if(e.target.closest(`.ao3h-module-quick-toggle`))return;let t=this.closest(`.ao3h-module-container`).querySelector(`.ao3h-config-btn`);t&&t.click();});});}function Ki(e,t){console.log(`[AO3H][tab-system] 📥 Loading tab:`,e);let n=w[e];if(!n){t.innerHTML=`<p style="color: #d32f2f;">❌ Unknown tab: ${e}</p>`;return}t.style.transition=`opacity 0.2s ease-out`,t.style.opacity=`0`,setTimeout(()=>{t.innerHTML=n,t.scrollTop=0,Mi(),Vi(t),setTimeout(()=>{t.style.opacity=`1`,Wi(t),Ii(t),Ui(t),Hi(t),Gi(t),Fi(t);},20),setTimeout(()=>{if(e!==`about`)Pi(t,e);else {let e=document.querySelector(`.${b}-bulk-actions`);e&&e.remove();let n=t.closest(`.${b}-panel-body`);if(n!=null&&n.parentElement){let e=document.createElement(`div`);e.className=`${b}-bulk-actions`,e.innerHTML=`
              <div class="note-box ao3h-footer-status" id="ao3h-panel-footer-status" aria-live="polite"></div>
              <button class="ao3h-panel-action-btn ao3h-footer-close">Close</button>
            `,n.parentElement.appendChild(e),$();}qi(t);}},10);},200),typeof window.initializeTabInteractivity==`function`&&window.initializeTabInteractivity(),console.log(`[AO3H][tab-system] ✅ Tab content loaded:`,e);}function qi(e){var t,n;let r=e.querySelector(`#ao3h-pinned-module`),i=e.querySelector(`#ao3h-pin-save-btn`);if(!r||!i)return;let a=((t=window.AO3H)==null||(t=t.modules)==null||(n=t.all)==null?void 0:n.call(t))||[];for(let{name:e,meta:t}of a){let n=document.createElement(`option`);n.value=e,n.textContent=(t==null?void 0:t.title)||e,r.appendChild(n);}let o=localStorage.getItem(`ao3h:pinnedModule`);o&&r.querySelector(`option[value="${o}"]`)&&(r.value=o),i.addEventListener(`click`,()=>{let e=r.value;e?localStorage.setItem(`ao3h:pinnedModule`,e):localStorage.removeItem(`ao3h:pinnedModule`);let t=i.textContent;i.textContent=`✓ Saved`,setTimeout(()=>{i.textContent=t;},1500);});}function Ji(e){console.log(`[AO3H][tab-system] Setting up tab switching`);let t=e.querySelectorAll(`.${b}-tab-btn`),n=e.querySelector(`#${b}-tab-container`);t.forEach(e=>{e.addEventListener(`click`,function(){let e=this.getAttribute(`data-tab`);t.forEach(e=>{e.classList.remove(`${b}-tab-active`),e.setAttribute(`aria-selected`,`false`);}),this.classList.add(`${b}-tab-active`),this.setAttribute(`aria-selected`,`true`),n.setAttribute(`aria-labelledby`,`${b}-tab-btn-${e}`),Ki(e,n),console.log(`[AO3H][tab-system] Switched to tab:`,e);});});let r=e.querySelector(`.ao3h-tab-btn.ao3h-tab-active`)||t[0],i=r?r.getAttribute(`data-tab`):`browse`;t.forEach(e=>e.setAttribute(`aria-selected`,e===r?`true`:`false`)),r&&n.setAttribute(`aria-labelledby`,`${b}-tab-btn-${i}`),console.log(`[AO3H][tab-system] Loading initial tab:`,i),Ki(i,n);}function Yi(e){let t=e.querySelector(`#${b}-tab-container`),n=e.querySelector(`#${b}-global-search`);if(!n||!t){console.warn(`[AO3H][global-search] Search input or tab container not found`);return}function r(){return pt$1||[]}let i=e.querySelector(`.ao3h-tab-btn.ao3h-tab-active`)||e.querySelector(`.ao3h-tab-btn`),a=i?i.getAttribute(`data-tab`):`browse`;e.querySelectorAll(`.${b}-tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{a=e.getAttribute(`data-tab`),n.value=``;});});let o;n.addEventListener(`input`,()=>{clearTimeout(o),o=setTimeout(()=>{let i=n.value.trim().toLowerCase(),o=r();if(!i){e.querySelectorAll(`.${b}-tab-btn`).forEach(e=>{e.classList.toggle(`${b}-tab-active`,e.getAttribute(`data-tab`)===a);}),Ki(a,t);return}e.querySelectorAll(`.${b}-tab-btn`).forEach(e=>e.classList.remove(`${b}-tab-active`)),s(o.filter(e=>(e.title||``).toLowerCase().includes(i)||(e.desc||``).toLowerCase().includes(i)||(e.id||``).toLowerCase().includes(i)||(e.tabLabel||``).toLowerCase().includes(i)),i,t);},150);});function s(e,t,n){let r;r=e.length===0?`<p class="ao3h-search-no-results">No modules found for "<strong>${t}</strong>"</p>`:e.map(e=>`

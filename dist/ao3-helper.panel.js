...
`;function _n(e$2){let t=e$2.querySelector(`#ao3h-sm-history`);if(!t)return;let n=e$1();if(!n.length){t.innerHTML=`<p class="ao3h-sm-history-empty">No draws yet.</p>`;return}t.innerHTML=`<ul class="ao3h-sm-history-list">${n.slice(0,20).map(e$1=>`
    <li>
  ...
  `).join(``)}</ul>`;}function vn(e){_n(e);let t=e.querySelector(`[data-action="clear-history"]`);t==null||t.addEventListener(`click`,()=>{r(),_n(e);});}var yn=`tropeGames`,bn=`
...
`;function Tn(e){let t=e.querySelector(`#ao3h-bv-statusFilter`),n=e.querySelector(`#ao3h-bv-statusFilter-opts`);!t||!n||t.dataset.wired||(t.dataset.wired=`1`,n.style.display=t.checked?``:`none`,t.addEventListener(`change`,()=>{n.style.display=t.checked?``:`none`;}));}var En=`fanficBingeMode`,Dn=`
...
`,Rn=e=>!!e&&typeof e==`object`&&!Array.isArray(e)&&Object.values(e).every(e=>typeof e==`string`),zn=e=>Array.isArray(e)&&e.length>0&&e.every(e=>Number.isInteger(e)&&e>=0&&e<=255);function Bn(e){return (e==null?void 0:e.type)||`standard`}function Vn(e){if(!e||typeof e!=`object`)return {valid:false,type:`unknown`,reason:`not an object`};let t=Bn(e);if(!e.timestamp||Number.isNaN(new Date(e.timestamp).getTime()))return {valid:false,type:t,reason:`invalid timestamp`};switch(t){case `standard`:case `selective`:return Rn(e.data)?{valid:true,type:t}:{valid:false,type:t,reason:`data is not a map of strings`};case `encrypted`:return zn(e.salt)&&zn(e.iv)&&zn(e.ciphertext)?{valid:true,type:t}:{valid:false,type:t,reason:`missing or corrupt salt/iv/ciphertext`};case `compressed`:return zn(e.compressed)?{valid:true,type:t}:{valid:false,type:t,reason:`missing or corrupt compressed bytes`};case `incremental`:return e.delta&&typeof e.delta==`object`&&!Array.isArray(e.delta)&&Object.values(e.delta).every(e=>e===null||typeof e==`string`)?{valid:true,type:t}:{valid:false,type:t,reason:`delta is not a map of strings/nulls`};default:return {valid:false,type:t,reason:`unknown type "${t}"`}}}function Hn(e){return Un.apply(this,arguments)}function Un(){return Un=t(function*(e){let t=Vn(e);if(!t.valid||t.type!==`compressed`)return t;try{let n=yield ar(e.compressed);return Rn(JSON.parse(n))?t:{valid:!1,type:`compressed`,reason:`decompressed payload is not a map of strings`}}catch(e){return {valid:false,type:`compressed`,reason:`gunzip failed`}}}),Un.apply(this,arguments)}function Wn(e){return {standard:`standard`,selective:`selective`,encrypted:`🔒 encrypted`,compressed:`📦 compressed`,incremental:`± incremental`}[e]||e}function Gn(e){let t=Bn(e);return t===`standard`||t===`selective`?Object.keys(e.data||{}).length:t===`incremental`?Object.keys(e.delta||{}).length:null}function Kn(e,t){let n=(t||``).trim().toLowerCase();return !!(!n||new Date(e.timestamp).toLocaleString().toLowerCase().includes(n)||Object.keys(e.data||e.delta||{}).some(e=>e.toLowerCase().includes(n))||Array.isArray(e.categories)&&e.categories.some(e=>String(e).toLowerCase().includes(n)))}function qn(e){return String(e||``).split(`,`).map(e=>e.trim()).filter(Boolean)}function Jn(e,t){if(!(t!=null&&t.length))return l({},e);let r={};for(let[n,i]of Object.entries(e||{}))t.some(e=>n.toLowerCase().includes(e.toLowerCase()))&&(r[n]=i);return r}function Yn(e,t){return Xn.apply(this,arguments)}function Xn(){return Xn=t(function*(e,t){let n=new TextEncoder,r=yield crypto.subtle.importKey(`raw`,n.encode(e),`PBKDF2`,false,[`deriveKey`]);return crypto.subtle.deriveKey({name:`PBKDF2`,salt:t,iterations:1e5,hash:`SHA-256`},r,{name:`AES-GCM`,length:256},false,[`encrypt`,`decrypt`])}),Xn.apply(this,arguments)}function Zn(e,t){return Qn.apply(this,arguments)}function Qn(){return Qn=t(function*(e,t){if(!t)throw Error(`Password required`);let n=new TextEncoder().encode(JSON.stringify(e)),r=crypto.getRandomValues(new Uint8Array(16)),i=crypto.getRandomValues(new Uint8Array(12)),a=yield Yn(t,r),o=yield crypto.subtle.encrypt({name:`AES-GCM`,iv:i},a,n);return {salt:Array.from(r),iv:Array.from(i),ciphertext:Array.from(new Uint8Array(o))}}),Qn.apply(this,arguments)}function $n(e,t){return er.apply(this,arguments)}function er(){return er=t(function*(e,t){try{let n=yield Yn(t,new Uint8Array(e.salt)),r=yield crypto.subtle.decrypt({name:`AES-GCM`,iv:new Uint8Array(e.iv)},n,new Uint8Array(e.ciphertext));return JSON.parse(new TextDecoder().decode(r))}catch(e){return null}}),er.apply(this,arguments)}function tr(e){return nr.apply(this,arguments)}function nr(){return nr=t(function*(e){let t=[],n=e.getReader(),r,i;for(;{done:r,value:i}=yield n.read(),!r;)t.push(i);let a=new Uint8Array(t.reduce((e,t)=>e+t.length,0)),o=0;for(let e of t)a.set(e,o),o+=e.length;return a}),nr.apply(this,arguments)}function rr(e){return ir.apply(this,arguments)}function ir(){return ir=t(function*(e){let t=new CompressionStream(`gzip`),n=t.writable.getWriter();return n.write(new TextEncoder().encode(e)).catch(()=>{}),n.close().catch(()=>{}),Array.from(yield tr(t.readable))}),ir.apply(this,arguments)}function ar(e){return or.apply(this,arguments)}function or(){return or=t(function*(e){let t=new DecompressionStream(`gzip`),n=t.writable.getWriter();return n.write(new Uint8Array(e)).catch(()=>{}),n.close().catch(()=>{}),new TextDecoder().decode(yield tr(t.readable))}),or.apply(this,arguments)}function sr(e,t){let n={};for(let[r,i]of Object.entries(t||{}))(e||{})[r]!==i&&(n[r]=i);for(let r of Object.keys(e||{}))r in(t||{})||(n[r]=null);return n}function cr(e,t=localStorage){for(let[n,r]of Object.entries(e||{}))try{r===null?t.removeItem(n):t.setItem(n,r);}catch(e){}}var lr=`backupAndSync`,ur=`
...
`,dr=`ao3h:backupAndSync:backups`;function fr(){try{let e=JSON.parse(localStorage.getItem(dr)||`[]`);return Array.isArray(e)?e:[]}catch(e){return []}}function pr(e){try{localStorage.setItem(dr,JSON.stringify(e));}catch(e){}}function mr(){let e={};for(let t=0;t<localStorage.length;t++){let n=localStorage.key(t);n&&(n.includes(`ao3h`)||n.includes(`AO3H`))&&n!==dr&&(e[n]=localStorage.getItem(n));}return e}function hr(e){return gr.apply(this,arguments)}function gr(){return gr=t(function*(e,{mode:t=`standard`,categories:r=[]}={}){let i=fr(),a=new Date().toISOString(),o;if(t===`encrypted`){let e=prompt(`Password for this encrypted backup:`);if(!e)return null;o=l({timestamp:a,type:`encrypted`},yield Zn(mr(),e));}else if(t===`compressed`)o={timestamp:a,type:`compressed`,compressed:yield rr(JSON.stringify(mr()))};else if(t===`incremental`){let e=i.find(e=>e.data&&typeof e.data==`object`)||null;o={timestamp:a,type:`incremental`,baseTimestamp:(e==null?void 0:e.timestamp)||null,delta:sr((e==null?void 0:e.data)||{},mr())};}else o=r.length?{timestamp:a,type:`selective`,categories:r,data:Jn(mr(),r)}:{timestamp:a,data:mr()};return i.unshift(o),i.length>e&&(i.length=e),pr(i),i}),gr.apply(this,arguments)}function _r(e,t){let n=new Blob([JSON.stringify(e,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,i.click(),URL.revokeObjectURL(r);}function vr(e){return e<1024?`${e} B`:`${(e/1024).toFixed(1)} KB`}function yr(t$1){let n=t$1.querySelector(`#ao3h-bas-list`),r=t$1.querySelector(`#ao3h-bas-search`);if(!n)return;function i(){var e;let n=parseInt((e=t$1.querySelector(`[data-setting="maxBackups"]`))==null?void 0:e.value,10);return Number.isFinite(n)&&n>0?n:10}function a(){let t$1=fr(),i=((r==null?void 0:r.value)||``).trim(),o=t$1.map((e,t)=>({b:e,idx:t})).filter(({b:e})=>Kn(e,i));if(n.innerHTML=``,!t$1.length){let e=document.createElement(`div`);e.className=`ao3h-bas-empty`,e.textContent=`No backups yet — click "Backup Now" to create one.`,n.appendChild(e);return}if(!o.length){let e=document.createElement(`div`);e.className=`ao3h-bas-empty`,e.textContent=`No backups match your search.`,n.appendChild(e);return}o.forEach(({b:t$1,idx:r})=>{let i=document.createElement(`div`);i.className=`ao3h-bas-row`;let o=Vn(t$1),s=document.createElement(`span`);s.className=`ao3h-bas-row-status`;let c=e=>{s.textContent=e.valid?`✓`:`⚠️`,s.classList.toggle(`ao3h-bas-row-status--bad`,!e.valid),s.title=e.valid?`Backup is valid and restorable`:`Corrupt backup: ${e.reason}`;};c(o),o.valid&&o.type===`compressed`&&Hn(t$1).then(e=>{s.isConnected&&c(e);});let l=document.createElement(`div`);l.className=`ao3h-bas-row-info`;let u=new Blob([JSON.stringify(t$1)]).size,d=Gn(t$1),f=[Wn(o.type)];d!==null&&f.push(`${d} keys`),f.push(vr(u)),l.textContent=`${new Date(t$1.timestamp).toLocaleString()} — ${f.join(`, `)}`;let p=document.createElement(`div`);p.className=`ao3h-bas-row-actions`;let m=document.createElement(`button`);m.type=`button`,m.className=`ao3h-config-action-btn ao3h-inline-btn`,m.textContent=`Restore`,m.addEventListener(`click`,t(function*(){let e=new Date(t$1.timestamp).toLocaleString();if(!Vn(t$1).valid){alert(`This backup is corrupt (${Vn(t$1).reason}) and cannot be restored.`);return}let n=Bn(t$1);if(n===`incremental`){if(!confirm(`Apply the incremental backup from ${e}?\n\nThis applies the stored changes (additions, edits, deletions) to current data. Reload the page afterwards.`))return;cr(t$1.delta),m.textContent=`✓ Restored`,setTimeout(()=>{m.textContent=`Restore`;},1500);return}let r=t$1.data;if(n===`encrypted`){let n=prompt(`Password for the encrypted backup from ${e}:`);if(!n)return;if(r=yield $n(t$1,n),!r){alert(`Decryption failed — wrong password or corrupt backup.`);return}}else if(n===`compressed`)try{r=JSON.parse(yield ar(t$1.compressed));}catch(e){alert(`This compressed backup could not be read.`);return}confirm(`Restore backup from ${e}?\n\nThis will overwrite current data. Reload the page afterwards to see the changes.`)&&(Object.entries(r||{}).forEach(([e,t])=>{try{localStorage.setItem(e,t);}catch(e){}}),m.textContent=`✓ Restored`,setTimeout(()=>{m.textContent=`Restore`;},1500));}));let h=document.createElement(`button`);h.type=`button`,h.className=`ao3h-config-action-btn ao3h-inline-btn ao3h-inline-btn--danger`,h.textContent=`🗑️`,h.title=`Delete this backup`,h.addEventListener(`click`,()=>{let e=fr();e.splice(r,1),pr(e),a();}),p.append(m,h),i.append(s,l,p),n.appendChild(i);});}if(r&&!r.dataset.wired){r.dataset.wired=`1`;let e=0;r.addEventListener(`input`,()=>{clearTimeout(e),e=setTimeout(a,150);});}let o=t$1.querySelector(`[data-action="backup-now"]`);o&&!o.dataset.wired&&(o.dataset.wired=`1`,o.addEventListener(`click`,t(function*(){var e,n;let r=((e=t$1.querySelector(`#ao3h-bas-mode`))==null?void 0:e.value)||`standard`,s=qn((n=t$1.querySelector(`#ao3h-bas-categories`))==null?void 0:n.value);(yield hr(i(),{mode:r,categories:s}))&&(a(),o.textContent=`✓ Backed Up`,setTimeout(()=>{o.textContent=`☁️ Backup Now`;},1500));})));let s=t$1.querySelector(`[data-action="export-backup"]`);s&&!s.dataset.wired&&(s.dataset.wired=`1`,s.addEventListener(`click`,()=>{let e=fr();if(!e.length){alert(`No backups to export yet.`);return}_r(e,`ao3h-backups-${new Date().toISOString().replace(/[:.]/g,`-`)}.json`);}));let c=t$1.querySelector(`[data-action="import-backup"]`);c&&!c.dataset.wired&&(c.dataset.wired=`1`,c.addEventListener(`click`,()=>{let e=document.createElement(`input`);e.type=`file`,e.accept=`.json,application/json`,e.addEventListener(`change`,()=>{var t;let n=(t=e.files)==null?void 0:t[0];if(!n)return;let r=new FileReader;r.onload=()=>{try{let e=JSON.parse(String(r.result));if(!Array.isArray(e))throw Error(`Expected an array of backups.`);let t=e.filter(e=>Vn(e).valid);if(!t.length)throw Error(`No valid backups found in file.`);pr(fr().concat(t).sort((e,t)=>new Date(t.timestamp).getTime()-new Date(e.timestamp).getTime()).slice(0,i())),a(),c.textContent=`✓ Imported ${t.length}`,setTimeout(()=>{c.textContent=`Import`;},1500);}catch(e){alert(`Import failed: `+((e==null?void 0:e.message)||`invalid file`));}},r.readAsText(n);}),e.click();}));let l=t$1.querySelector(`[data-action="clear-all-backups"]`);l&&!l.dataset.wired&&(l.dataset.wired=`1`,l.addEventListener(`click`,()=>{fr().length&&confirm(`Delete all backups? This cannot be undone.`)&&(pr([]),a());})),a();}var br=`ao3h:OfflineReading:library`,xr=4*1024*1024;function Sr(e=localStorage){try{let t=JSON.parse(e.getItem(`ao3h:OfflineReading:library`)||`{}`);return t&&typeof t==`object`&&!Array.isArray(t)?t:{}}catch(e){return {}}}function Cr(e){return !Number.isFinite(e)||e<0?`0 B`:e<1024?`${Math.round(e)} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/(1024*1024)).toFixed(1)} MB`}function wr(e){try{return JSON.stringify(e||{}).length*2}catch(e){return 0}}function Tr(e){return Object.entries(e||{}).map(([e,t])=>{let n=wr(t);return {workId:e,title:(t==null?void 0:t.title)||`Work ${e}`,author:(t==null?void 0:t.author)||`Anonymous`,date:(t==null?void 0:t.date)||0,dateLabel:t!=null&&t.date?new Date(t.date).toLocaleString():`—`,sizeLabel:Cr(n),bytes:n}}).sort((e,t)=>t.date-e.date)}function Er(e,t=xr){let n=0,r=Object.values(e||{});for(let e of r)n+=wr(e);return {count:r.length,bytes:n,label:`${r.length} work${r.length===1?``:`s`} — ${Cr(n)}`,warn:n>=t}}function Dr(e,t=localStorage){let n=Sr(t);delete n[e];try{t.setItem(br,JSON.stringify(n));}catch(e){}return n}function Or(e=localStorage){try{e.setItem(br,`{}`);}catch(e){}return {}}var kr=`ficDownloader`,Ar=`
...
`;function jr(e,t,n){let r=e.querySelector(t),i=e.querySelector(n);!r||!i||r.dataset.wired||(r.dataset.wired=`1`,i.style.display=r.checked?``:`none`,r.addEventListener(`change`,()=>{i.style.display=r.checked?``:`none`;}));}function Mr(e){if(!(e!=null&&e.html)||typeof URL.createObjectURL!=`function`)return;let t=new Blob([e.html],{type:`text/html;charset=utf-8`}),n=URL.createObjectURL(t);window.open(n,`_blank`)?setTimeout(()=>URL.revokeObjectURL(n),1e4):URL.revokeObjectURL(n);}function Nr(e){let t=e.querySelector(`#ao3h-dl-offline-list`),n=e.querySelector(`#ao3h-dl-offline-total`),r=e.querySelector(`#ao3h-dl-offline-search`);if(!t)return;function i(){let e=Sr(),a=((r==null?void 0:r.value)||``).trim().toLowerCase(),o=Tr(e).filter(e=>!a||e.title.toLowerCase().includes(a)||e.author.toLowerCase().includes(a)),s=Er(e);if(n&&(n.textContent=s.count?`${s.label}${s.warn?` — ⚠️ close to the browser storage limit`:``}`:``,n.classList.toggle(`ao3h-dl-offline-total--warn`,s.warn)),t.innerHTML=``,!o.length){let e=document.createElement(`div`);e.className=`ao3h-dl-offline-empty`,e.textContent=s.count?`No offline works match your search.`:`No works saved offline yet — use "📥 Save Offline" on a work page.`,t.appendChild(e);return}o.forEach(e=>{let n=document.createElement(`div`);n.className=`ao3h-dl-offline-row`;let r=document.createElement(`div`);r.className=`ao3h-dl-offline-row-info`,r.textContent=`${e.title} — ${e.author} (${e.dateLabel}, ${e.sizeLabel})`,r.title=`Work ${e.workId}`;let a=document.createElement(`div`);a.className=`ao3h-dl-offline-row-actions`;let o=document.createElement(`button`);o.type=`button`,o.className=`ao3h-config-action-btn ao3h-inline-btn`,o.textContent=`📖 Read`,o.title=`Open the cached copy in a new tab`,o.addEventListener(`click`,()=>{Mr(Sr()[e.workId]);});let s=document.createElement(`button`);s.type=`button`,s.className=`ao3h-config-action-btn ao3h-inline-btn ao3h-inline-btn--danger`,s.textContent=`🗑️`,s.title=`Remove from offline library`,s.addEventListener(`click`,()=>{Dr(e.workId),i();}),a.append(o,s),n.append(r,a),t.appendChild(n);});}if(r&&!r.dataset.wired){r.dataset.wired=`1`;let e=0;r.addEventListener(`input`,()=>{clearTimeout(e),e=setTimeout(i,150);});}let a=e.querySelector(`[data-action="clear-offline-library"]`);a&&!a.dataset.wired&&(a.dataset.wired=`1`,a.addEventListener(`click`,()=>{Er(Sr()).count&&confirm(`Remove all works saved offline? This cannot be undone.`)&&(Or(),i());})),i();}function Pr(e){jr(e,`#ao3h-dl-kindle`,`#ao3h-dl-kindle-opts`),jr(e,`#ao3h-dl-calibre`,`#ao3h-dl-calibre-opts`),Nr(e);}var Fr=`themeBuilder`,Ir=`
...
`},Br={[zr.moduleId]:zr.config,[re]:ie,[T]:E,[I]:L,[Ie]:Le,[ze]:Be,[dt]:ft,[At]:jt,[Mt]:Nt,[Pt]:Ft,[It]:Lt,[Rt]:zt,[Bt]:Vt,[Ht]:Ut,[Wt]:Gt,[Kt]:qt,[Jt]:Yt,[Xt]:Qt,[en]:tn,[nn]:rn,[an]:on,[sn]:cn,[ln]:un,[dn]:fn,[pn]:mn,[hn]:gn,[yn]:bn,[xn]:Sn,[Cn]:wn,[En]:Dn,[On]:kn,[An]:jn,[Mn]:Nn,[Pn]:Fn,[In]:Ln,[lr]:ur,[kr]:Ar,[Fr]:Ir,[Lr]:Rr};function Vr(e){return Br[e]||Br._default}function Hr(){return Object.keys(Br).filter(e=>e!==`_default`&&typeof Br[e]==`string`)}var Z={};typeof F==`function`&&(Z[T]=F),typeof Fe==`function`&&(Z[I]=Fe),typeof yr==`function`&&(Z[lr]=yr),typeof Pr==`function`&&(Z[kr]=Pr),typeof Tn==`function`&&(Z[Cn]=Tn),typeof vn==`function`&&(Z[hn]=vn),typeof $t==`function`&&(Z[Xt]=$t);function Ur(e,t){let n=Z[e];typeof n==`function`&&n(t);}console.log(`[AO3H][panel-configs] Panel configs index loaded - `+Hr().length+` modules registered`);var Wr=typeof unsafeWindow<`u`?unsafeWindow:window,Q={pendingSaves:0,dirty:false,_savedTimer:null};function Gr(){return (ut$1==null?void 0:ut$1.length)||0}function Kr(){var e,t,n,r,i,a;let o=((e=window.AO3H)==null?void 0:e.flags)||((t=Wr.AO3H)==null?void 0:t.flags),s=((n=window.AO3H)==null||(n=n.modules)==null||(r=n.all)==null?void 0:r.call(n))||((i=Wr.AO3H)==null||(i=i.modules)==null||(a=i.all)==null?void 0:a.call(i))||[];return !o||typeof o.get!=`function`||!s.length?s.filter(e=>e==null?void 0:e._booted).length:s.reduce((e,t)=>{var n;let r=(t==null?void 0:t.enabledKey)||`mod:${t==null?void 0:t.name}:enabled`,i=!!(!(t==null||(n=t.meta)==null)&&n.enabledByDefault);return e+ +!!o.get(r,i)},0)}function $(){let e=document.getElementById(`ao3h-panel-footer-status`);e&&(e.innerHTML=`<strong>${Kr()}</strong> enabled · ${Gr()} modules total · ${Q.dirty?`<span class="ao3h-footer-unsaved">Unsaved changes</span>`:`All changes saved`}`);}function qr(){Q.pendingSaves+=1,Q.dirty=true,clearTimeout(Q._savedTimer),$();}function Jr(e){if(Q.pendingSaves>0&&--Q.pendingSaves,e===false){Q.dirty=true,$();return}clearTimeout(Q._savedTimer),Q._savedTimer=setTimeout(()=>{Q.pendingSaves===0&&(Q.dirty=false),$();},1500);}function Yr(){document.querySelectorAll(`[data-config-module]`).forEach(e=>{let t=e.dataset.configModule,n=Vr(t);(e.innerHTML=n,Ur(t,e));});}function Xr(e,t){e.addEventListener(`click`,S),t.querySelectorAll(`.${b}-panel-close, .ao3h-footer-close`).forEach(e=>{e.addEventListener(`click`,S);});let n=function(e){e.key===`Escape`&&(S(),document.removeEventListener(`keydown`,n));};document.addEventListener(`keydown`,n),console.log(`[AO3H][tab-system] ✅ Close handlers attached`);}function Zr(e,t){var n;let r=e.closest(`.${b}-panel-body`),i=r==null||(n=r.parentElement)==null?void 0:n.querySelector(`.${b}-bulk-actions`);i&&i.remove();let a=document.createElement(`div`);a.className=`${b}-bulk-actions`,a.innerHTML=`
    ...
    `,r!=null&&r.parentElement&&(r.parentElement.appendChild(a),a.querySelector(`.ao3h-footer-save-close`).addEventListener(`click`,ni)),$();let o=r==null?void 0:r.closest(`.${b}-panel-box`);o==null||o.querySelectorAll(`.ao3h-bulk-actions-buttons .ao3h-panel-action-btn[data-action]`).forEach(t=>{let n=t.cloneNode(true);t.replaceWith(n),n.addEventListener(`click`,function(){let t=this.getAttribute(`data-action`),n=e.querySelectorAll(`.ao3h-quick-enable-checkbox`),r=t===`enable-all`;n.forEach(e=>{e.checked=r,e.dispatchEvent(new Event(`change`,{bubbles:true}));}),console.log(`[AO3H][tab-system] ${t}: ${n.length} modules`);});}),console.log(`[AO3H][tab-system] ✅ Bulk actions setup for tab:`,t);}function Qr(e){e.querySelectorAll(`.ao3h-picker-row`).forEach(e=>{let t=e.querySelector(`.ao3h-picker`),n=e.querySelector(`[data-action^="add"]`),r=e.parentElement.querySelector(`.ao3h-chip-container`);if(!t||!n||!r)return;let i=t.dataset.pickerType||`item`,a=[];try{let e=r.dataset.value;e&&(a=JSON.parse(e));}catch(e){}function o(){r.innerHTML=``,a.forEach(e=>{let n=t.querySelector(`option[value="${e}"]`);c(e,n?n.textContent:e,false);}),s();}function s(){r.dataset.value=JSON.stringify(a),r.dispatchEvent(new CustomEvent(`chipsChanged`,{detail:{type:i,items:a},bubbles:true}));}function c(e,t,n=true){n&&!a.includes(e)&&a.push(e);let o=document.createElement(`span`);o.className=`ao3h-chip`,o.dataset.value=e,o.innerHTML=`${t} <button type="button" title="Remove ${t}" aria-label="Remove ${t}">×</button>`,o.querySelector(`button`).addEventListener(`click`,()=>{o.remove(),a=a.filter(t=>t!==e),s(),console.log(`[AO3H][chip-picker:${i}] Removed:`,e);}),r.appendChild(o);}function l(){var e;let n=t.value;if(!n)return;let r=(e=t.options[t.selectedIndex])==null?void 0:e.text;if(a.includes(n)){console.log(`[AO3H][chip-picker:${i}] Already added:`,n);return}c(n,r,true),s(),t.selectedIndex=0,console.log(`[AO3H][chip-picker:${i}] Added:`,n,`| Total:`,a.length);}n.addEventListener(`click`,l),t.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),l());}),o(),console.log(`[AO3H][tab-system] ✅ Chip picker setup (${i})`);});}function $r(e){e.querySelectorAll(`.ao3h-config-reset-btn`).forEach(e=>{let t=null,n=e.textContent.trim(),r=e.dataset.fullReset===`true`;e.addEventListener(`click`,function(){if(this.classList.contains(`ao3h-reset-confirming`))if(clearTimeout(t),this.classList.remove(`ao3h-reset-confirming`),this.textContent=n,r){try{Object.keys(localStorage).filter(e=>e.startsWith(`ao3h`)).forEach(e=>localStorage.removeItem(e));}catch(e){}location.reload();}else {let e=this.closest(`.ao3h-module-config-area`);e&&e.querySelectorAll(`input, select, textarea`).forEach(e=>{e.type===`checkbox`||e.type===`radio`?e.checked=e.defaultChecked:e.tagName===`SELECT`?Array.from(e.options).forEach(e=>{e.selected=e.defaultSelected;}):e.value=e.defaultValue,e.dispatchEvent(new Event(`change`,{bubbles:true}));}),console.log(`[AO3H][tab-system] Module reset confirmed`);}else this.classList.add(`ao3h-reset-confirming`),this.textContent=r?`⚠ Reset everything?`:`⚠ Confirm reset?`,t=setTimeout(()=>{this.classList.remove(`ao3h-reset-confirming`),this.textContent=n;},3e3);});});}function ei(e){return ti.apply(this,arguments)}function ti(){return ti=t(function*(e){var n,r;let i=e.dataset.configModule;if(!i)return;let a=e.querySelectorAll(`[data-setting]`),o={},s=new Set;a.forEach(t=>{let n=t.dataset.setting;if(n)if(t.type===`checkbox`)o[n]=t.checked;else if(t.type===`radio`){if(!s.has(n)){s.add(n);let t=e.querySelector(`input[type="radio"][data-setting="${n}"]:checked`);t&&(o[n]=t.value);}}else o[n]=t.value;});let c=((n=window.AO3H)==null?void 0:n.settings)||((r=Wr.AO3H)==null?void 0:r.settings);if(c)yield c.set(i,o);else {let e=`ao3h:mod:${i}:settings`,t=JSON.parse(localStorage.getItem(e)||`{}`);localStorage.setItem(e,JSON.stringify(Object.assign({},t,o)));}document.dispatchEvent(new CustomEvent(v$1,{bubbles:false,detail:{moduleId:i,settings:o}}));}),ti.apply(this,arguments)}function ni(){return ri.apply(this,arguments)}function ri(){return ri=t(function*(){let e=document.querySelectorAll(`.ao3h-module-config-area`);for(let t of e)try{yield ei(t);}catch(e){console.error(`[AO3H][tab-system] Save failed for`,t.dataset.configModule,e);}Q.dirty=false,Q.pendingSaves=0,S();}),ri.apply(this,arguments)}function ii(e){e.querySelectorAll(`[data-config-module]`).forEach(e=>{let t=e.dataset.configModule;if(t)try{let n=localStorage.getItem(`ao3h:mod:${t}:settings`);if(!n)return;let r=JSON.parse(n);e.querySelectorAll(`[data-setting]`).forEach(e=>{let t=e.dataset.setting;t in r&&(e.type===`checkbox`?e.checked=!!r[t]:e.type===`radio`?e.checked=e.value===r[t]:e.value=r[t]);});}catch(e){}});}function ai(e){e.querySelectorAll(`.ao3h-module-config-area`).forEach(e=>{e.dataset.autoSaveWired||(e.dataset.autoSaveWired=`1`,e.addEventListener(`change`,e=>{e.target.closest(`[data-setting]`)&&(Q.dirty=true,clearTimeout(Q._savedTimer),$());}));});}function oi(t$1){t$1.querySelectorAll(`.ao3h-config-save-btn`).forEach(t$1=>{t$1.addEventListener(`click`,t(function*(){let e=this.closest(`.ao3h-module-config-area`);if(!e||!e.dataset.configModule)return;qr();try{yield ei(e),Jr(!0);}catch(t){Jr(false),console.error(`[AO3H][tab-system] Save failed for`,e.dataset.configModule,t);return}let t=this.textContent;this.textContent=`✓ Saved`,this.classList.add(`ao3h-save-success`),setTimeout(()=>{this.textContent=t,this.classList.remove(`ao3h-save-success`);},1500);}));});}function si(e){e.querySelectorAll(`.ao3h-config-btn`).forEach(e=>{e.setAttribute(`aria-label`,`Module settings`),e.setAttribute(`aria-expanded`,`false`),e.addEventListener(`click`,function(e){e.stopPropagation();let t=this.closest(`.ao3h-module-container`),n=t.querySelector(`.ao3h-module-config-area`);if(n){let e=n.classList.contains(`ao3h-expanded`);if(n.classList.toggle(`ao3h-expanded`),this.textContent=e?`▼`:`▲`,this.setAttribute(`aria-expanded`,e?`false`:`true`),!e){let e=t.dataset.moduleId;Ur(e,n),n.dispatchEvent(new CustomEvent(`ao3h:configOpen`,{bubbles:true,detail:{moduleId:e,configArea:n}})),setTimeout(()=>{typeof window.AO3H_wireHelpButtons==`function`&&window.AO3H_wireHelpButtons(n);},0),setTimeout(()=>{let e=document.querySelector(`#ao3h-tab-container`);if(!e)return;let n=t.getBoundingClientRect(),r=e.getBoundingClientRect(),i=n.top-r.top;Math.abs(i)>5&&e.scrollBy({top:i,behavior:`smooth`});},450);}console.log(`[AO3H][tab-system] Config toggled:`,e?`closed`:`opened`);}});});}function ci(t$1){t$1.querySelectorAll(`.ao3h-module-row`).forEach(t$1=>{let n=t$1.closest(`.ao3h-module-container`),r=n==null?void 0:n.dataset.moduleId,i=t$1.querySelector(`.ao3h-quick-enable-checkbox`);if(i&&r){var a,o,s,c,l,u,d;let n=((a=t$1.querySelector(`.ao3h-module-name`))==null||(a=a.textContent)==null?void 0:a.trim())||r;i.setAttribute(`aria-label`,`Enable ${n}`);let f=((o=window.AO3H)==null?void 0:o.flags)||((s=Wr.AO3H)==null?void 0:s.flags),p=(c=window.AO3H)==null?void 0:c.modules,m=p==null||(l=p.all)==null||(l=l.call(p))==null||(u=l.find)==null?void 0:u.call(l,e=>e.name===r),h=!!(!(m==null||(d=m.meta)==null)&&d.enabledByDefault);i.checked=f?!!f.get(`mod:${r}:enabled`,h):h,i.addEventListener(`change`,t(function*(){if(r){try{var e,t;let n=((e=Wr.AO3H)==null?void 0:e.modules)||((t=window.AO3H)==null?void 0:t.modules);n!=null&&n.setEnabled&&(yield n.setEnabled(r,this.checked)),$();}catch(e){console.error(`[AO3H][tab-system] setEnabled failed for`,r,e);}document.dispatchEvent(new CustomEvent(`ao3h:flags-updated`,{detail:{key:`mod:${r}:enabled`,value:this.checked}})),console.log(`[AO3H][tab-system]`,r,this.checked?`enabled`:`disabled`);}})),document.addEventListener(`ao3h:flags-updated`,function(e){var t;((t=e.detail)==null?void 0:t.key)===`mod:${r}:enabled`&&(i.checked=!!e.detail.value);});}t$1.addEventListener(`click`,function(e){if(e.target.closest(`.ao3h-module-quick-toggle`))return;let t=this.closest(`.ao3h-module-container`).querySelector(`.ao3h-config-btn`);t&&t.click();});});}function li(e,t){console.log(`[AO3H][tab-system] 📥 Loading tab:`,e);let n=w[e];if(!n){t.innerHTML=`<p style="color: #d32f2f;">❌ Unknown tab: ${e}</p>`;return}t.style.transition=`opacity 0.2s ease-out`,t.style.opacity=`0`,setTimeout(()=>{t.innerHTML=n,t.scrollTop=0,Yr(),ii(t),setTimeout(()=>{t.style.opacity=`1`,si(t),$r(t),oi(t),ai(t),ci(t),Qr(t);},20),setTimeout(()=>{if(e!==`about`)Zr(t,e);else {let e=document.querySelector(`.${b}-bulk-actions`);e&&e.remove();let n=t.closest(`.${b}-panel-body`);if(n!=null&&n.parentElement){let e=document.createElement(`div`);e.className=`${b}-bulk-actions`,e.innerHTML=`
              <div class="note-box ao3h-footer-status" id="ao3h-panel-footer-status" aria-live="polite"></div>
              <button class="ao3h-panel-action-btn ao3h-footer-close">Close</button>
            `,n.parentElement.appendChild(e),$();}ui(t);}},10);},200),typeof window.initializeTabInteractivity==`function`&&window.initializeTabInteractivity(),console.log(`[AO3H][tab-system] ✅ Tab content loaded:`,e);}function ui(e){var t,n;let r=e.querySelector(`#ao3h-pinned-module`),i=e.querySelector(`#ao3h-pin-save-btn`);if(!r||!i)return;let a=((t=window.AO3H)==null||(t=t.modules)==null||(n=t.all)==null?void 0:n.call(t))||[];for(let{name:e,meta:t}of a){let n=document.createElement(`option`);n.value=e,n.textContent=(t==null?void 0:t.title)||e,r.appendChild(n);}let o=localStorage.getItem(`ao3h:pinnedModule`);o&&r.querySelector(`option[value="${o}"]`)&&(r.value=o),i.addEventListener(`click`,()=>{let e=r.value;e?localStorage.setItem(`ao3h:pinnedModule`,e):localStorage.removeItem(`ao3h:pinnedModule`);let t=i.textContent;i.textContent=`✓ Saved`,setTimeout(()=>{i.textContent=t;},1500);});}function di(e){console.log(`[AO3H][tab-system] Setting up tab switching`);let t=e.querySelectorAll(`.${b}-tab-btn`),n=e.querySelector(`#${b}-tab-container`);t.forEach(e=>{e.addEventListener(`click`,function(){let e=this.getAttribute(`data-tab`);t.forEach(e=>{e.classList.remove(`${b}-tab-active`),e.setAttribute(`aria-selected`,`false`);}),this.classList.add(`${b}-tab-active`),this.setAttribute(`aria-selected`,`true`),n.setAttribute(`aria-labelledby`,`${b}-tab-btn-${e}`),li(e,n),console.log(`[AO3H][tab-system] Switched to tab:`,e);});});let r=e.querySelector(`.ao3h-tab-btn.ao3h-tab-active`)||t[0],i=r?r.getAttribute(`data-tab`):`browse`;t.forEach(e=>e.setAttribute(`aria-selected`,e===r?`true`:`false`)),r&&n.setAttribute(`aria-labelledby`,`${b}-tab-btn-${i}`),console.log(`[AO3H][tab-system] Loading initial tab:`,i),li(i,n);}function fi(e){let t=e.querySelector(`#${b}-tab-container`),n=e.querySelector(`#${b}-global-search`);if(!n||!t){console.warn(`[AO3H][global-search] Search input or tab container not found`);return}function r(){return ut$1||[]}let i=e.querySelector(`.ao3h-tab-btn.ao3h-tab-active`)||e.querySelector(`.ao3h-tab-btn`),a=i?i.getAttribute(`data-tab`):`browse`;e.querySelectorAll(`.${b}-tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{a=e.getAttribute(`data-tab`),n.value=``;});});let o;n.addEventListener(`input`,()=>{clearTimeout(o),o=setTimeout(()=>{let i=n.value.trim().toLowerCase(),o=r();if(!i){e.querySelectorAll(`.${b}-tab-btn`).forEach(e=>{e.classList.toggle(`${b}-tab-active`,e.getAttribute(`data-tab`)===a);}),li(a,t);return}e.querySelectorAll(`.${b}-tab-btn`).forEach(e=>e.classList.remove(`${b}-tab-active`)),s(o.filter(e=>(e.title||``).toLowerCase().includes(i)||(e.desc||``).toLowerCase().includes(i)||(e.id||``).toLowerCase().includes(i)||(e.tabLabel||``).toLowerCase().includes(i)),i,t);},150);});function s(e,t,n){let r;r=e.length===0?`<p class="ao3h-search-no-results">No modules found for "<strong>${t}</strong>"</p>`:e.map(e=>`

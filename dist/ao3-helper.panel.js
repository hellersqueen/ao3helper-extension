...
`,Zt=`keyboardShortcuts`,Qt=[`prevChapter`,`nextChapter`,`prevPage`,`nextPage`,`firstPage`,`lastPage`,`jumpBackPages`,`jumpForwardPages`,`guide`,`commandPalette`,`surpriseMe`,`subscribe`,`bookmark`,`markForLater`,`kudos`],$t=`
...
`;function en(t$1){let n$1=t$1.querySelector(`[data-action="export-shortcuts"]`);n$1&&!n$1.dataset.wired&&(n$1.dataset.wired=`1`,n$1.addEventListener(`click`,()=>{let e=a(Zt),t={};Qt.forEach(n=>{n in e&&(t[n]=e[n]);}),n(t,`ao3h-keyboard-shortcuts.json`);}));let r=t$1.querySelector(`[data-action="import-shortcuts"]`);r&&!r.dataset.wired&&(r.dataset.wired=`1`,r.addEventListener(`click`,t(function*(){let e;try{e=yield i();}catch(e){alert(`Import failed: invalid JSON file.`);return}if(!e||typeof e!=`object`)return;let n={};if(Qt.forEach(t=>{typeof e[t]==`string`&&(n[t]=e[t]);}),!Object.keys(n).length){alert(`No recognized shortcut keys found in file.`);return}s(Zt,n),Object.entries(n).forEach(([e,n])=>{let r=t$1.querySelector(`[data-setting="${e}"]`);r&&(r.value=n);}),r.textContent=`✓ Imported ${Object.keys(n).length}`,setTimeout(()=>{r.textContent=`Import`;},1500);})));}var tn=`mainNavigation`,nn=`
...
`;function rn(e,t){return an.apply(this,arguments)}function an(){return an=t(function*(e,t){let n=`/autocomplete/${e}?term=${encodeURIComponent(t)}`,r=yield fetch(n,{headers:{Accept:`application/json`}});if(!r.ok)throw Error(`HTTP ${r.status}`);let i=yield r.json();return Array.isArray(i)?i:[]}),an.apply(this,arguments)}function on(e){let t=e.replace(/\*/g,`*x*`).replace(/\//g,`*s*`).replace(/&/g,`*a*`).replace(/\./g,`*d*`).replace(/\?/g,`*q*`).replace(/#/g,`*h*`);return `/tags/${encodeURIComponent(t)}/works`}function sn(e,t,n){for(let r=1;r<=5;r+=1){let i=e.querySelector(`[data-setting="quickLink${r}Label"]`),a=e.querySelector(`[data-setting="quickLink${r}Url"]`);if(!i||!a)return  false;if(!i.value&&!a.value)return i.value=t,a.value=n,a.dispatchEvent(new Event(`change`,{bubbles:true})),true}return  false}function cn(t$1){let n=t$1.querySelector(`[data-action="search-tag"]`),r=t$1.querySelector(`#ao3h-mn-ac-term`),i=t$1.querySelector(`#ao3h-mn-ac-type`),a=t$1.querySelector(`#ao3h-mn-ac-results`);if(!n||!r||!i||!a||n.dataset.wired)return;n.dataset.wired=`1`;function o(){return s.apply(this,arguments)}function s(){return s=t(function*(){let e=r.value.trim();if(!e)return;a.textContent=`Searching…`;let n;try{n=yield rn(i.value,e);}catch(e){a.textContent=`Search failed — are you on an AO3 page?`;return}if(a.textContent=``,!n.length){a.textContent=`No matching tag found.`;return}n.slice(0,8).forEach(e=>{let n=document.createElement(`li`),r=document.createElement(`button`);r.className=`ao3h-config-action-btn ao3h-inline-btn`,r.textContent=`+ ${e.name}`,r.title=`Add as quick link`,r.addEventListener(`click`,()=>{let n=sn(t$1,e.name,on(e.name));r.textContent=n?`✓ Added`:`All 5 slots full`,r.disabled=true;}),n.appendChild(r),a.appendChild(n);});}),s.apply(this,arguments)}n.addEventListener(`click`,o),r.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),o());});}var ln=`seriesHelper`,un=`
...
`,_r=`ao3h:backupAndSync:backups`;function X(){try{let e=JSON.parse(localStorage.getItem(_r)||`[]`);return Array.isArray(e)?e:[]}catch(e){return []}}function vr(e){try{localStorage.setItem(_r,JSON.stringify(e));}catch(e){}}function yr(){let e={};for(let t=0;t<localStorage.length;t++){let n=localStorage.key(t);n&&(n.includes(`ao3h`)||n.includes(`AO3H`))&&n!==_r&&(e[n]=localStorage.getItem(n));}return e}function br(e){return xr.apply(this,arguments)}function xr(){return xr=t(function*(e,{mode:n=`standard`,categories:r=[]}={}){let i=X(),a=new Date().toISOString(),o;if(n===`encrypted`){let e=prompt(`Password for this encrypted backup:`);if(!e)return null;o=l({timestamp:a,type:`encrypted`},yield rr(yr(),e));}else if(n===`compressed`)o={timestamp:a,type:`compressed`,compressed:yield lr(JSON.stringify(yr()))};else if(n===`incremental`){let e=i.find(e=>e.data&&typeof e.data==`object`)||null;o={timestamp:a,type:`incremental`,baseTimestamp:(e==null?void 0:e.timestamp)||null,delta:pr((e==null?void 0:e.data)||{},yr())};}else o=r.length?{timestamp:a,type:`selective`,categories:r,data:er(yr(),r)}:{timestamp:a,data:yr()};return i.unshift(o),i.length>e&&(i.length=e),vr(i),i}),xr.apply(this,arguments)}function Sr(e,t){let n=new Blob([JSON.stringify(e,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,i.click(),URL.revokeObjectURL(r);}function Cr(e){return e<1024?`${e} B`:`${(e/1024).toFixed(1)} KB`}function wr(t$1){let n=t$1.querySelector(`#ao3h-bas-list`),r=t$1.querySelector(`#ao3h-bas-search`);if(!n)return;function i(){var e;let n=parseInt((e=t$1.querySelector(`[data-setting="maxBackups"]`))==null?void 0:e.value,10);return Number.isFinite(n)&&n>0?n:10}function a(){let t$1=X(),i=((r==null?void 0:r.value)||``).trim(),o=t$1.map((e,t)=>({b:e,idx:t})).filter(({b:e})=>Qn(e,i));if(n.innerHTML=``,!t$1.length){let e=document.createElement(`div`);e.className=`ao3h-bas-empty`,e.textContent=`No backups yet — click "Backup Now" to create one.`,n.appendChild(e);return}if(!o.length){let e=document.createElement(`div`);e.className=`ao3h-bas-empty`,e.textContent=`No backups match your search.`,n.appendChild(e);return}o.forEach(({b:t$1,idx:r})=>{let i=document.createElement(`div`);i.className=`ao3h-bas-row`;let o=qn(t$1),s=document.createElement(`span`);s.className=`ao3h-bas-row-status`;let c=e=>{s.textContent=e.valid?`✓`:`⚠️`,s.classList.toggle(`ao3h-bas-row-status--bad`,!e.valid),s.title=e.valid?`Backup is valid and restorable`:`Corrupt backup: ${e.reason}`;};c(o),o.valid&&o.type===`compressed`&&Jn(t$1).then(e=>{s.isConnected&&c(e);});let l=document.createElement(`div`);l.className=`ao3h-bas-row-info`;let u=new Blob([JSON.stringify(t$1)]).size,d=Zn(t$1),f=[Xn(o.type)];d!==null&&f.push(`${d} keys`),f.push(Cr(u)),l.textContent=`${new Date(t$1.timestamp).toLocaleString()} — ${f.join(`, `)}`;let p=document.createElement(`div`);p.className=`ao3h-bas-row-actions`;let m=document.createElement(`button`);m.type=`button`,m.className=`ao3h-config-action-btn ao3h-inline-btn`,m.textContent=`Restore`,m.addEventListener(`click`,t(function*(){let e=new Date(t$1.timestamp).toLocaleString();if(!qn(t$1).valid){alert(`This backup is corrupt (${qn(t$1).reason}) and cannot be restored.`);return}let n=Kn(t$1);if(n===`incremental`){if(!confirm(`Apply the incremental backup from ${e}?\n\nThis applies the stored changes (additions, edits, deletions) to current data. Reload the page afterwards.`))return;mr(t$1.delta),m.textContent=`✓ Restored`,setTimeout(()=>{m.textContent=`Restore`;},1500);return}let r=t$1.data;if(n===`encrypted`){let n=prompt(`Password for the encrypted backup from ${e}:`);if(!n)return;if(r=yield ar(t$1,n),!r){alert(`Decryption failed — wrong password or corrupt backup.`);return}}else if(n===`compressed`)try{r=JSON.parse(yield dr(t$1.compressed));}catch(e){alert(`This compressed backup could not be read.`);return}confirm(`Restore backup from ${e}?\n\nThis will overwrite current data. Reload the page afterwards to see the changes.`)&&(Object.entries(r||{}).forEach(([e,t])=>{try{localStorage.setItem(e,t);}catch(e){}}),m.textContent=`✓ Restored`,setTimeout(()=>{m.textContent=`Restore`;},1500));}));let h=document.createElement(`button`);h.type=`button`,h.className=`ao3h-config-action-btn ao3h-inline-btn ao3h-inline-btn--danger`,h.textContent=`🗑️`,h.title=`Delete this backup`,h.addEventListener(`click`,()=>{let e=X();e.splice(r,1),vr(e),a();}),p.append(m,h),i.append(s,l,p),n.appendChild(i);});}if(r&&!r.dataset.wired){r.dataset.wired=`1`;let e=0;r.addEventListener(`input`,()=>{clearTimeout(e),e=setTimeout(a,150);});}let o=t$1.querySelector(`[data-action="backup-now"]`);o&&!o.dataset.wired&&(o.dataset.wired=`1`,o.addEventListener(`click`,t(function*(){var e,n;let r=((e=t$1.querySelector(`#ao3h-bas-mode`))==null?void 0:e.value)||`standard`,s=$n((n=t$1.querySelector(`#ao3h-bas-categories`))==null?void 0:n.value);(yield br(i(),{mode:r,categories:s}))&&(a(),o.textContent=`✓ Backed Up`,setTimeout(()=>{o.textContent=`☁️ Backup Now`;},1500));})));let s=t$1.querySelector(`[data-action="export-backup"]`);s&&!s.dataset.wired&&(s.dataset.wired=`1`,s.addEventListener(`click`,()=>{let e=X();if(!e.length){alert(`No backups to export yet.`);return}Sr(e,`ao3h-backups-${new Date().toISOString().replace(/[:.]/g,`-`)}.json`);}));let c=t$1.querySelector(`[data-action="import-backup"]`);c&&!c.dataset.wired&&(c.dataset.wired=`1`,c.addEventListener(`click`,()=>{let e=document.createElement(`input`);e.type=`file`,e.accept=`.json,application/json`,e.addEventListener(`change`,()=>{var t;let n=(t=e.files)==null?void 0:t[0];if(!n)return;let r=new FileReader;r.onload=()=>{try{let e=JSON.parse(String(r.result));if(!Array.isArray(e))throw Error(`Expected an array of backups.`);let t=e.filter(e=>qn(e).valid);if(!t.length)throw Error(`No valid backups found in file.`);vr(X().concat(t).sort((e,t)=>new Date(t.timestamp).getTime()-new Date(e.timestamp).getTime()).slice(0,i())),a(),c.textContent=`✓ Imported ${t.length}`,setTimeout(()=>{c.textContent=`Import`;},1500);}catch(e){alert(`Import failed: `+((e==null?void 0:e.message)||`invalid file`));}},r.readAsText(n);}),e.click();}));let l=t$1.querySelector(`[data-action="clear-all-backups"]`);l&&!l.dataset.wired&&(l.dataset.wired=`1`,l.addEventListener(`click`,()=>{X().length&&confirm(`Delete all backups? This cannot be undone.`)&&(vr([]),a());})),a();}var Tr=`ao3h:OfflineReading:library`,Er=4*1024*1024;function Dr(e=localStorage){try{let t=JSON.parse(e.getItem(`ao3h:OfflineReading:library`)||`{}`);return t&&typeof t==`object`&&!Array.isArray(t)?t:{}}catch(e){return {}}}function Or(e){return !Number.isFinite(e)||e<0?`0 B`:e<1024?`${Math.round(e)} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/(1024*1024)).toFixed(1)} MB`}function kr(e){try{return JSON.stringify(e||{}).length*2}catch(e){return 0}}function Ar(e){return Object.entries(e||{}).map(([e,t])=>{let n=kr(t);return {workId:e,title:(t==null?void 0:t.title)||`Work ${e}`,author:(t==null?void 0:t.author)||`Anonymous`,date:(t==null?void 0:t.date)||0,dateLabel:t!=null&&t.date?new Date(t.date).toLocaleString():`—`,sizeLabel:Or(n),bytes:n}}).sort((e,t)=>t.date-e.date)}function jr(e,t=Er){let n=0,r=Object.values(e||{});for(let e of r)n+=kr(e);return {count:r.length,bytes:n,label:`${r.length} work${r.length===1?``:`s`} — ${Or(n)}`,warn:n>=t}}function Mr(e,t=localStorage){let n=Dr(t);delete n[e];try{t.setItem(Tr,JSON.stringify(n));}catch(e){}return n}function Nr(e=localStorage){try{e.setItem(Tr,`{}`);}catch(e){}return {}}var Pr=`ficDownloader`,Fr=`
...
`;function Ir(e,t,n){let r=e.querySelector(t),i=e.querySelector(n);!r||!i||r.dataset.wired||(r.dataset.wired=`1`,i.style.display=r.checked?``:`none`,r.addEventListener(`change`,()=>{i.style.display=r.checked?``:`none`;}));}function Lr(e){if(!(e!=null&&e.html)||typeof URL.createObjectURL!=`function`)return;let t=new Blob([e.html],{type:`text/html;charset=utf-8`}),n=URL.createObjectURL(t);window.open(n,`_blank`)?setTimeout(()=>URL.revokeObjectURL(n),1e4):URL.revokeObjectURL(n);}function Rr(e){let t=e.querySelector(`#ao3h-dl-offline-list`),n=e.querySelector(`#ao3h-dl-offline-total`),r=e.querySelector(`#ao3h-dl-offline-search`);if(!t)return;function i(){let e=Dr(),a=((r==null?void 0:r.value)||``).trim().toLowerCase(),o=Ar(e).filter(e=>!a||e.title.toLowerCase().includes(a)||e.author.toLowerCase().includes(a)),s=jr(e);if(n&&(n.textContent=s.count?`${s.label}${s.warn?` — ⚠️ close to the browser storage limit`:``}`:``,n.classList.toggle(`ao3h-dl-offline-total--warn`,s.warn)),t.innerHTML=``,!o.length){let e=document.createElement(`div`);e.className=`ao3h-dl-offline-empty`,e.textContent=s.count?`No offline works match your search.`:`No works saved offline yet — use "📥 Save Offline" on a work page.`,t.appendChild(e);return}o.forEach(e=>{let n=document.createElement(`div`);n.className=`ao3h-dl-offline-row`;let r=document.createElement(`div`);r.className=`ao3h-dl-offline-row-info`,r.textContent=`${e.title} — ${e.author} (${e.dateLabel}, ${e.sizeLabel})`,r.title=`Work ${e.workId}`;let a=document.createElement(`div`);a.className=`ao3h-dl-offline-row-actions`;let o=document.createElement(`button`);o.type=`button`,o.className=`ao3h-config-action-btn ao3h-inline-btn`,o.textContent=`📖 Read`,o.title=`Open the cached copy in a new tab`,o.addEventListener(`click`,()=>{Lr(Dr()[e.workId]);});let s=document.createElement(`button`);s.type=`button`,s.className=`ao3h-config-action-btn ao3h-inline-btn ao3h-inline-btn--danger`,s.textContent=`🗑️`,s.title=`Remove from offline library`,s.addEventListener(`click`,()=>{Mr(e.workId),i();}),a.append(o,s),n.append(r,a),t.appendChild(n);});}if(r&&!r.dataset.wired){r.dataset.wired=`1`;let e=0;r.addEventListener(`input`,()=>{clearTimeout(e),e=setTimeout(i,150);});}let a=e.querySelector(`[data-action="clear-offline-library"]`);a&&!a.dataset.wired&&(a.dataset.wired=`1`,a.addEventListener(`click`,()=>{jr(Dr()).count&&confirm(`Remove all works saved offline? This cannot be undone.`)&&(Nr(),i());})),i();}function zr(e){Ir(e,`#ao3h-dl-kindle`,`#ao3h-dl-kindle-opts`),Ir(e,`#ao3h-dl-calibre`,`#ao3h-dl-calibre-opts`),Rr(e);}var Br=`themeBuilder`,Vr=`
...
`},Gr={[Wr.moduleId]:Wr.config,[re]:ie,[T]:E,[F]:I,[Le]:Re,[Be]:Ve,[ft]:pt,[jt]:Mt,[Nt]:Pt,[Ft]:It,[Lt]:Rt,[zt]:Bt,[Vt]:Ht,[Ut]:Wt,[Gt]:Kt,[qt]:Jt,[Yt]:Xt,[Zt]:$t,[tn]:nn,[ln]:un,[dn]:fn,[pn]:mn,[hn]:gn,[_n]:vn,[yn]:bn,[xn]:Sn,[Tn]:En,[Dn]:On,[kn]:An,[Mn]:Nn,[Pn]:Fn,[In]:Ln,[Rn]:zn,[Bn]:Vn,[Hn]:Un,[hr]:gr,[Pr]:Fr,[Br]:Vr,[Hr]:Ur};function Kr(e){return Gr[e]||Gr._default}function qr(){return Object.keys(Gr).filter(e=>e!==`_default`&&typeof Gr[e]==`string`)}var Z={};typeof P==`function`&&(Z[T]=P),typeof Ie==`function`&&(Z[F]=Ie),typeof wr==`function`&&(Z[hr]=wr),typeof zr==`function`&&(Z[Pr]=zr),typeof jn==`function`&&(Z[kn]=jn),typeof wn==`function`&&(Z[xn]=wn),typeof en==`function`&&(Z[Zt]=en),typeof cn==`function`&&(Z[tn]=cn);function Jr(e,t){let n=Z[e];typeof n==`function`&&n(t);}console.log(`[AO3H][panel-configs] Panel configs index loaded - `+qr().length+` modules registered`);var Yr=typeof unsafeWindow<`u`?unsafeWindow:window,Q={pendingSaves:0,dirty:false,_savedTimer:null};function Xr(){return (ft$1==null?void 0:ft$1.length)||0}function Zr(){var e,t,n,r,i,a;let o=((e=window.AO3H)==null?void 0:e.flags)||((t=Yr.AO3H)==null?void 0:t.flags),s=((n=window.AO3H)==null||(n=n.modules)==null||(r=n.all)==null?void 0:r.call(n))||((i=Yr.AO3H)==null||(i=i.modules)==null||(a=i.all)==null?void 0:a.call(i))||[];return !o||typeof o.get!=`function`||!s.length?s.filter(e=>e==null?void 0:e._booted).length:s.reduce((e,t)=>{var n;let r=(t==null?void 0:t.enabledKey)||`mod:${t==null?void 0:t.name}:enabled`,i=!!(!(t==null||(n=t.meta)==null)&&n.enabledByDefault);return e+ +!!o.get(r,i)},0)}function $(){let e=document.getElementById(`ao3h-panel-footer-status`);e&&(e.innerHTML=`<strong>${Zr()}</strong> enabled · ${Xr()} modules total · ${Q.dirty?`<span class="ao3h-footer-unsaved">Unsaved changes</span>`:`All changes saved`}`);}function Qr(){Q.pendingSaves+=1,Q.dirty=true,clearTimeout(Q._savedTimer),$();}function $r(e){if(Q.pendingSaves>0&&--Q.pendingSaves,e===false){Q.dirty=true,$();return}clearTimeout(Q._savedTimer),Q._savedTimer=setTimeout(()=>{Q.pendingSaves===0&&(Q.dirty=false),$();},1500);}function ei(){document.querySelectorAll(`[data-config-module]`).forEach(e=>{let t=e.dataset.configModule,n=Kr(t);(e.innerHTML=n,Jr(t,e));});}function ti(e,t){e.addEventListener(`click`,S),t.querySelectorAll(`.${b}-panel-close, .ao3h-footer-close`).forEach(e=>{e.addEventListener(`click`,S);});let n=function(e){e.key===`Escape`&&(S(),document.removeEventListener(`keydown`,n));};document.addEventListener(`keydown`,n),console.log(`[AO3H][tab-system] ✅ Close handlers attached`);}function ni(e,t){var n;let r=e.closest(`.${b}-panel-body`),i=r==null||(n=r.parentElement)==null?void 0:n.querySelector(`.${b}-bulk-actions`);i&&i.remove();let a=document.createElement(`div`);a.className=`${b}-bulk-actions`,a.innerHTML=`
    ...
    `,r!=null&&r.parentElement&&(r.parentElement.appendChild(a),a.querySelector(`.ao3h-footer-save-close`).addEventListener(`click`,si)),$();let o=r==null?void 0:r.closest(`.${b}-panel-box`);o==null||o.querySelectorAll(`.ao3h-bulk-actions-buttons .ao3h-panel-action-btn[data-action]`).forEach(t=>{let n=t.cloneNode(true);t.replaceWith(n),n.addEventListener(`click`,function(){let t=this.getAttribute(`data-action`),n=e.querySelectorAll(`.ao3h-quick-enable-checkbox`),r=t===`enable-all`;n.forEach(e=>{e.checked=r,e.dispatchEvent(new Event(`change`,{bubbles:true}));}),console.log(`[AO3H][tab-system] ${t}: ${n.length} modules`);});}),console.log(`[AO3H][tab-system] ✅ Bulk actions setup for tab:`,t);}function ri(e){e.querySelectorAll(`.ao3h-picker-row`).forEach(e=>{let t=e.querySelector(`.ao3h-picker`),n=e.querySelector(`[data-action^="add"]`),r=e.parentElement.querySelector(`.ao3h-chip-container`);if(!t||!n||!r)return;let i=t.dataset.pickerType||`item`,a=[];try{let e=r.dataset.value;e&&(a=JSON.parse(e));}catch(e){}function o(){r.innerHTML=``,a.forEach(e=>{let n=t.querySelector(`option[value="${e}"]`);c(e,n?n.textContent:e,false);}),s();}function s(){r.dataset.value=JSON.stringify(a),r.dispatchEvent(new CustomEvent(`chipsChanged`,{detail:{type:i,items:a},bubbles:true}));}function c(e,t,n=true){n&&!a.includes(e)&&a.push(e);let o=document.createElement(`span`);o.className=`ao3h-chip`,o.dataset.value=e,o.innerHTML=`${t} <button type="button" title="Remove ${t}" aria-label="Remove ${t}">×</button>`,o.querySelector(`button`).addEventListener(`click`,()=>{o.remove(),a=a.filter(t=>t!==e),s(),console.log(`[AO3H][chip-picker:${i}] Removed:`,e);}),r.appendChild(o);}function l(){var e;let n=t.value;if(!n)return;let r=(e=t.options[t.selectedIndex])==null?void 0:e.text;if(a.includes(n)){console.log(`[AO3H][chip-picker:${i}] Already added:`,n);return}c(n,r,true),s(),t.selectedIndex=0,console.log(`[AO3H][chip-picker:${i}] Added:`,n,`| Total:`,a.length);}n.addEventListener(`click`,l),t.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),l());}),o(),console.log(`[AO3H][tab-system] ✅ Chip picker setup (${i})`);});}function ii(e){e.querySelectorAll(`.ao3h-config-reset-btn`).forEach(e=>{let t=null,n=e.textContent.trim(),r=e.dataset.fullReset===`true`;e.addEventListener(`click`,function(){if(this.classList.contains(`ao3h-reset-confirming`))if(clearTimeout(t),this.classList.remove(`ao3h-reset-confirming`),this.textContent=n,r){try{Object.keys(localStorage).filter(e=>e.startsWith(`ao3h`)).forEach(e=>localStorage.removeItem(e));}catch(e){}location.reload();}else {let e=this.closest(`.ao3h-module-config-area`);e&&e.querySelectorAll(`input, select, textarea`).forEach(e=>{e.type===`checkbox`||e.type===`radio`?e.checked=e.defaultChecked:e.tagName===`SELECT`?Array.from(e.options).forEach(e=>{e.selected=e.defaultSelected;}):e.value=e.defaultValue,e.dispatchEvent(new Event(`change`,{bubbles:true}));}),console.log(`[AO3H][tab-system] Module reset confirmed`);}else this.classList.add(`ao3h-reset-confirming`),this.textContent=r?`⚠ Reset everything?`:`⚠ Confirm reset?`,t=setTimeout(()=>{this.classList.remove(`ao3h-reset-confirming`),this.textContent=n;},3e3);});});}function ai(e){return oi.apply(this,arguments)}function oi(){return oi=t(function*(e){var t,r;let i=e.dataset.configModule;if(!i)return;let a=e.querySelectorAll(`[data-setting]`),o={},s=new Set;a.forEach(t=>{let n=t.dataset.setting;if(n)if(t.type===`checkbox`)o[n]=t.checked;else if(t.type===`radio`){if(!s.has(n)){s.add(n);let t=e.querySelector(`input[type="radio"][data-setting="${n}"]:checked`);t&&(o[n]=t.value);}}else o[n]=t.value;});let c=((t=window.AO3H)==null?void 0:t.settings)||((r=Yr.AO3H)==null?void 0:r.settings);if(c)yield c.set(i,o);else {let e=`ao3h:mod:${i}:settings`,t=JSON.parse(localStorage.getItem(e)||`{}`);localStorage.setItem(e,JSON.stringify(Object.assign({},t,o)));}document.dispatchEvent(new CustomEvent(v$1,{bubbles:false,detail:{moduleId:i,settings:o}}));}),oi.apply(this,arguments)}function si(){return ci.apply(this,arguments)}function ci(){return ci=t(function*(){let e=document.querySelectorAll(`.ao3h-module-config-area`);for(let t of e)try{yield ai(t);}catch(e){console.error(`[AO3H][tab-system] Save failed for`,t.dataset.configModule,e);}Q.dirty=false,Q.pendingSaves=0,S();}),ci.apply(this,arguments)}function li(e){e.querySelectorAll(`[data-config-module]`).forEach(e=>{let t=e.dataset.configModule;if(t)try{let n=localStorage.getItem(`ao3h:mod:${t}:settings`);if(!n)return;let r=JSON.parse(n);e.querySelectorAll(`[data-setting]`).forEach(e=>{let t=e.dataset.setting;t in r&&(e.type===`checkbox`?e.checked=!!r[t]:e.type===`radio`?e.checked=e.value===r[t]:e.value=r[t]);});}catch(e){}});}function ui(e){e.querySelectorAll(`.ao3h-module-config-area`).forEach(e=>{e.dataset.autoSaveWired||(e.dataset.autoSaveWired=`1`,e.addEventListener(`change`,e=>{e.target.closest(`[data-setting]`)&&(Q.dirty=true,clearTimeout(Q._savedTimer),$());}));});}function di(t$1){t$1.querySelectorAll(`.ao3h-config-save-btn`).forEach(t$1=>{t$1.addEventListener(`click`,t(function*(){let e=this.closest(`.ao3h-module-config-area`);if(!e||!e.dataset.configModule)return;Qr();try{yield ai(e),$r(!0);}catch(t){$r(false),console.error(`[AO3H][tab-system] Save failed for`,e.dataset.configModule,t);return}let t=this.textContent;this.textContent=`✓ Saved`,this.classList.add(`ao3h-save-success`),setTimeout(()=>{this.textContent=t,this.classList.remove(`ao3h-save-success`);},1500);}));});}function fi(e){e.querySelectorAll(`.ao3h-config-btn`).forEach(e=>{e.setAttribute(`aria-label`,`Module settings`),e.setAttribute(`aria-expanded`,`false`),e.addEventListener(`click`,function(e){e.stopPropagation();let t=this.closest(`.ao3h-module-container`),n=t.querySelector(`.ao3h-module-config-area`);if(n){let e=n.classList.contains(`ao3h-expanded`);if(n.classList.toggle(`ao3h-expanded`),this.textContent=e?`▼`:`▲`,this.setAttribute(`aria-expanded`,e?`false`:`true`),!e){let e=t.dataset.moduleId;Jr(e,n),n.dispatchEvent(new CustomEvent(`ao3h:configOpen`,{bubbles:true,detail:{moduleId:e,configArea:n}})),setTimeout(()=>{typeof window.AO3H_wireHelpButtons==`function`&&window.AO3H_wireHelpButtons(n);},0),setTimeout(()=>{let e=document.querySelector(`#ao3h-tab-container`);if(!e)return;let n=t.getBoundingClientRect(),r=e.getBoundingClientRect(),i=n.top-r.top;Math.abs(i)>5&&e.scrollBy({top:i,behavior:`smooth`});},450);}console.log(`[AO3H][tab-system] Config toggled:`,e?`closed`:`opened`);}});});}function pi(t$1){t$1.querySelectorAll(`.ao3h-module-row`).forEach(t$1=>{let n=t$1.closest(`.ao3h-module-container`),r=n==null?void 0:n.dataset.moduleId,i=t$1.querySelector(`.ao3h-quick-enable-checkbox`);if(i&&r){var a,o,s,c,l,u,d;let n=((a=t$1.querySelector(`.ao3h-module-name`))==null||(a=a.textContent)==null?void 0:a.trim())||r;i.setAttribute(`aria-label`,`Enable ${n}`);let f=((o=window.AO3H)==null?void 0:o.flags)||((s=Yr.AO3H)==null?void 0:s.flags),p=(c=window.AO3H)==null?void 0:c.modules,m=p==null||(l=p.all)==null||(l=l.call(p))==null||(u=l.find)==null?void 0:u.call(l,e=>e.name===r),h=!!(!(m==null||(d=m.meta)==null)&&d.enabledByDefault);i.checked=f?!!f.get(`mod:${r}:enabled`,h):h,i.addEventListener(`change`,t(function*(){if(r){try{var e,t;let n=((e=Yr.AO3H)==null?void 0:e.modules)||((t=window.AO3H)==null?void 0:t.modules);n!=null&&n.setEnabled&&(yield n.setEnabled(r,this.checked)),$();}catch(e){console.error(`[AO3H][tab-system] setEnabled failed for`,r,e);}document.dispatchEvent(new CustomEvent(`ao3h:flags-updated`,{detail:{key:`mod:${r}:enabled`,value:this.checked}})),console.log(`[AO3H][tab-system]`,r,this.checked?`enabled`:`disabled`);}})),document.addEventListener(`ao3h:flags-updated`,function(e){var t;((t=e.detail)==null?void 0:t.key)===`mod:${r}:enabled`&&(i.checked=!!e.detail.value);});}t$1.addEventListener(`click`,function(e){if(e.target.closest(`.ao3h-module-quick-toggle`))return;let t=this.closest(`.ao3h-module-container`).querySelector(`.ao3h-config-btn`);t&&t.click();});});}function mi(e,t){console.log(`[AO3H][tab-system] 📥 Loading tab:`,e);let n=w[e];if(!n){t.innerHTML=`<p style="color: #d32f2f;">❌ Unknown tab: ${e}</p>`;return}t.style.transition=`opacity 0.2s ease-out`,t.style.opacity=`0`,setTimeout(()=>{t.innerHTML=n,t.scrollTop=0,ei(),li(t),setTimeout(()=>{t.style.opacity=`1`,fi(t),ii(t),di(t),ui(t),pi(t),ri(t);},20),setTimeout(()=>{if(e!==`about`)ni(t,e);else {let e=document.querySelector(`.${b}-bulk-actions`);e&&e.remove();let n=t.closest(`.${b}-panel-body`);if(n!=null&&n.parentElement){let e=document.createElement(`div`);e.className=`${b}-bulk-actions`,e.innerHTML=`
              <div class="note-box ao3h-footer-status" id="ao3h-panel-footer-status" aria-live="polite"></div>
              <button class="ao3h-panel-action-btn ao3h-footer-close">Close</button>
            `,n.parentElement.appendChild(e),$();}hi(t);}},10);},200),typeof window.initializeTabInteractivity==`function`&&window.initializeTabInteractivity(),console.log(`[AO3H][tab-system] ✅ Tab content loaded:`,e);}function hi(e){var t,n;let r=e.querySelector(`#ao3h-pinned-module`),i=e.querySelector(`#ao3h-pin-save-btn`);if(!r||!i)return;let a=((t=window.AO3H)==null||(t=t.modules)==null||(n=t.all)==null?void 0:n.call(t))||[];for(let{name:e,meta:t}of a){let n=document.createElement(`option`);n.value=e,n.textContent=(t==null?void 0:t.title)||e,r.appendChild(n);}let o=localStorage.getItem(`ao3h:pinnedModule`);o&&r.querySelector(`option[value="${o}"]`)&&(r.value=o),i.addEventListener(`click`,()=>{let e=r.value;e?localStorage.setItem(`ao3h:pinnedModule`,e):localStorage.removeItem(`ao3h:pinnedModule`);let t=i.textContent;i.textContent=`✓ Saved`,setTimeout(()=>{i.textContent=t;},1500);});}function gi(e){console.log(`[AO3H][tab-system] Setting up tab switching`);let t=e.querySelectorAll(`.${b}-tab-btn`),n=e.querySelector(`#${b}-tab-container`);t.forEach(e=>{e.addEventListener(`click`,function(){let e=this.getAttribute(`data-tab`);t.forEach(e=>{e.classList.remove(`${b}-tab-active`),e.setAttribute(`aria-selected`,`false`);}),this.classList.add(`${b}-tab-active`),this.setAttribute(`aria-selected`,`true`),n.setAttribute(`aria-labelledby`,`${b}-tab-btn-${e}`),mi(e,n),console.log(`[AO3H][tab-system] Switched to tab:`,e);});});let r=e.querySelector(`.ao3h-tab-btn.ao3h-tab-active`)||t[0],i=r?r.getAttribute(`data-tab`):`browse`;t.forEach(e=>e.setAttribute(`aria-selected`,e===r?`true`:`false`)),r&&n.setAttribute(`aria-labelledby`,`${b}-tab-btn-${i}`),console.log(`[AO3H][tab-system] Loading initial tab:`,i),mi(i,n);}function _i(e){let t=e.querySelector(`#${b}-tab-container`),n=e.querySelector(`#${b}-global-search`);if(!n||!t){console.warn(`[AO3H][global-search] Search input or tab container not found`);return}function r(){return ft$1||[]}let i=e.querySelector(`.ao3h-tab-btn.ao3h-tab-active`)||e.querySelector(`.ao3h-tab-btn`),a=i?i.getAttribute(`data-tab`):`browse`;e.querySelectorAll(`.${b}-tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{a=e.getAttribute(`data-tab`),n.value=``;});});let o;n.addEventListener(`input`,()=>{clearTimeout(o),o=setTimeout(()=>{let i=n.value.trim().toLowerCase(),o=r();if(!i){e.querySelectorAll(`.${b}-tab-btn`).forEach(e=>{e.classList.toggle(`${b}-tab-active`,e.getAttribute(`data-tab`)===a);}),mi(a,t);return}e.querySelectorAll(`.${b}-tab-btn`).forEach(e=>e.classList.remove(`${b}-tab-active`)),s(o.filter(e=>(e.title||``).toLowerCase().includes(i)||(e.desc||``).toLowerCase().includes(i)||(e.id||``).toLowerCase().includes(i)||(e.tabLabel||``).toLowerCase().includes(i)),i,t);},150);});function s(e,t,n){let r;r=e.length===0?`<p class="ao3h-search-no-results">No modules found for "<strong>${t}</strong>"</p>`:e.map(e=>`

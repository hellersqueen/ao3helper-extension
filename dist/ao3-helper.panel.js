...
<div class="ao3h-tab-content" data-tab="about">
    <div style="max-width: 600px; margin: 0 auto; padding: 16px;">
        ...
        <div style="padding: 14px; background: #f9f9f9; border-radius: 8px; margin-bottom: 16px;">
            <p style="color: #555; line-height: 1.6; font-size: 13px; margin: 0;">AO3 Helper enhances your Archive of Our Own experience with ${ut$1.length} modules across ${R$1.length} categories — covering reading, filtering, bookmarking, navigation, appearance, and more.</p>
        </div>

        <div style="display: flex; gap: 12px; margin-bottom: 16px;">
            <div style="flex: 1; padding: 12px; background: #fff5f5; border-radius: 8px; text-align: center;">
                <div style="font-size: 24px; font-weight: 700; color: #900;">${ut$1.length}</div>
    ...
    `}var w=Object.fromEntries([...R$1.map(e=>[e.id,te(e)]),[`about`,ne()]]);console.log(`[AO3H][panel-tab-content] Tab content generated - ${R$1.length} tabs + About, ${ut$1.length} modules`);var re=`ficEngagement`,ie=`

...
<div class="ao3h-tab-content" data-tab="about">
    ...
    `}var ne=Object.fromEntries([...R$1.map(e=>[e.id,C(e)]),[`about`,te()]]);console.log(`[AO3H][panel-tab-content] Tab content generated - ${R$1.length} tabs + About, ${dt$1.length} modules`);var w=`ficEngagement`,re=`
...
`;function Ue(e,t){let n=Array.isArray(e)?e:[],r=String(t||``).trim().toLowerCase();return r?n.filter(e=>{if(!e)return  false;let t=String(e.workId||``).replace(/^\/works\//,``).split(`/`)[0];return [e.title,e.author,e.reason,e.workId,t].filter(Boolean).join(` `).toLowerCase().includes(r)}):n}var We=((Be=(typeof unsafeWindow<`u`?unsafeWindow:window).AO3H)==null||(Be=Be.env)==null?void 0:Be.NS)||`ao3h`,Ge=we$1||null,Ke=`m5QuickTagsUser`,q=`works`;function qe(){return xe$1()||`guest`}var Je=null;function Ye(){return new Promise((e,t)=>{if(Je){e(Je);return}let n=`ao3h-hiddenWorksDB-${qe()}`,r=indexedDB.open(n,1);r.onupgradeneeded=()=>{let e=r.result;if(!e.objectStoreNames.contains(q)){let t=e.createObjectStore(q,{keyPath:`workId`});t.createIndex(`reason`,`reason`,{unique:false}),t.createIndex(`isHidden`,`isHidden`,{unique:false});}},r.onsuccess=()=>{Je=r.result,e(Je);},r.onerror=()=>t(r.error);})}function Xe(){return Ze.apply(this,arguments)}function Ze(){return Ze=t(function*(){let e=yield Ye();return new Promise((t,n)=>{let r=e.transaction(q,`readonly`).objectStore(q).getAll();r.onsuccess=()=>t(r.result||[]),r.onerror=()=>n(r.error);})}),Ze.apply(this,arguments)}function Qe(e){return $e.apply(this,arguments)}function $e(){return $e=t(function*(e){let t=yield Ye();return new Promise((n,r)=>{let i=t.transaction(q,`readonly`).objectStore(q).get(e);i.onsuccess=()=>n(i.result||null),i.onerror=()=>r(i.error);})}),$e.apply(this,arguments)}function et(e){return tt.apply(this,arguments)}function tt(){return tt=t(function*(e){let t=yield Ye();return new Promise((n,r)=>{let i=t.transaction(q,`readwrite`).objectStore(q).put(e);i.onsuccess=()=>n(),i.onerror=()=>r(i.error);})}),tt.apply(this,arguments)}function nt(){try{let e=Ge?Ge.getJSON(Ke,null):JSON.parse(localStorage.getItem(`${We}:${Ke}`)||`null`);return Array.isArray(e)?e:[`Crossover`,`AU`,`Not my ship`,`Too long`,`Already read`]}catch(e){return []}}function rt(e){try{Ge?Ge.setJSON(Ke,e):localStorage.setItem(`${We}:${Ke}`,JSON.stringify(e));}catch(e){}}function it(e){return at.apply(this,arguments)}function at(){return at=t(function*(t$1,n=``){let r=t$1||document,i=r.querySelector(`#ao3h-skipWorks-list-container`)||document.getElementById(`ao3h-skipWorks-list-container`),a=r.querySelector(`#ao3h-skipWorks-count`)||document.getElementById(`ao3h-skipWorks-count`);if(!i)return;let o;try{o=yield Xe();}catch(e){console.error(`[AO3H][skipWorks-config] Failed to load works list:`,e),i.innerHTML=`<p style="color:#c00;font-size:11px;padding:6px 0;margin:0;">⚠ Could not load skipped works list (${(e==null?void 0:e.message)||e}).</p>`;return}let s=o.filter(e=>e.isHidden),c=Ue(s,n);if(a&&(a.textContent=n.trim()?`${c.length} of ${s.length} work${s.length===1?``:`s`} skipped`:`${s.length} work${s.length===1?``:`s`} skipped`),s.length===0){i.innerHTML=`<p style="color:#bbb;font-size:11px;font-style:italic;padding:6px 0;margin:0;">No works skipped yet.</p>`;return}if(c.length===0){i.innerHTML=`<p style="color:#bbb;font-size:11px;font-style:italic;padding:6px 0;margin:0;">No skipped works match “${e(n.trim())}”.</p>`;return}let l=document.createElement(`div`);l.className=`ao3h-module-list ao3h-skipworks-list`;for(let e$1 of c){let t=e$1.workId.replace(/^\/works\//,``).split(`/`)[0],n=document.createElement(`div`);n.className=`ao3h-module-list-entry ao3h-skipworks-entry`,n.dataset.workId=e$1.workId,n.innerHTML=`
      ...
      </div>`,a.appendChild(n);}n.innerHTML=``,n.appendChild(a),n.dataset.removeNoteWired||(n.dataset.removeNoteWired=`1`,n.addEventListener(`click`,function(){var n=t(function*(e){let n=e.target.closest(`[data-action="remove-note"]`);if(!n)return;let r=n.closest(`.ao3h-skipworks-entry`).dataset.workId;if(!confirm(`Remove this private note?`))return;let i=yield Qe(r);i&&(i.reason=``,i.isStandaloneNote=false,yield et(i)),yield st(t$1);});return function(e){return n.apply(this,arguments)}}()));}),ct.apply(this,arguments)}function lt(e){let t=e?e.querySelector(`#ao3h-skipWorks-presets-container`):document.getElementById(`ao3h-skipWorks-presets-container`);if(!t)return;function n(){let e=nt();t.innerHTML=`
...
`,Wt=`ao3h:rt:history`,Gt=`ao3h:rt:excludedWorks`;function Kt(){try{return JSON.parse(localStorage.getItem(Wt)||`[]`)}catch(e){return []}}function qt(e){try{localStorage.setItem(Wt,JSON.stringify(e));}catch(e){}}function Jt(){try{return JSON.parse(localStorage.getItem(Gt)||`[]`)}catch(e){return []}}function Yt(e){try{localStorage.setItem(Gt,JSON.stringify(e));}catch(e){}}function J(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Xt(e){if(!e)return ``;let t=Math.round((Date.now()-e)/864e5);return t<=0?`today`:t===1?`yesterday`:t<30?`${t} days ago`:new Date(e).toLocaleDateString(`en-US`,{year:`numeric`,month:`short`,day:`numeric`})}function Zt(e){let t=new Date(Date.now());t.setHours(0,0,0,0);let n=t.getTime(),r=n-864e5,i=n-7*864e5,a={Today:[],Yesterday:[],"This week":[],Older:[]};for(let t of e){let e=t.lastReadAt||t.seenAt||0;e>=n?a.Today.push(t):e>=r?a.Yesterday.push(t):e>=i?a[`This week`].push(t):a.Older.push(t);}return a}function Qt(e){let t=e.lastReadAt||e.seenAt;return `
    ...
    </li>`).join(``),t.querySelectorAll(`.ao3h-rt-exclusion-remove`).forEach(t=>{t.addEventListener(`click`,()=>{Yt(Jt().filter(e=>e!==t.dataset.value)),en();});});}function tn(e){let n=e.querySelector(`#ao3h-rt-history-list`);if(n&&!n.dataset.wired){var r,i,a;n.dataset.wired=`1`;let o=()=>$t(n);(r=e.querySelector(`#ao3h-rt-search`))==null||r.addEventListener(`input`,o),(i=e.querySelector(`#ao3h-rt-sort`))==null||i.addEventListener(`change`,o),(a=e.querySelector(`#ao3h-rt-group-period`))==null||a.addEventListener(`change`,o),n.addEventListener(`click`,e=>{var n;let r=e.target.closest(`[data-action="rt-pin"]`),i=e.target.closest(`[data-action="rt-note"]`),a=e.target.closest(`[data-action="delete-entry"]`),s=(n=e.target.closest(`.ao3h-rt-history-entry`))==null?void 0:n.dataset.id;if(s)if(r)qt(Kt().map(e=>e.id===s?l(l({},e),{},{pinned:!e.pinned}):e)),o();else if(i){let e=Kt(),n=e.find(e=>e.id===s),r=window.prompt(`Personal note for this entry:`,(n==null?void 0:n.note)||``);if(r===null)return;qt(e.map(e=>e.id===s?l(l({},e),{},{note:r.trim()||void 0}):e)),o();}else a&&(qt(Kt().filter(e=>e.id!==s)),o());}),o();}let o=e.querySelector(`[data-action="rt-cleanup"]`);o&&!o.dataset.wired&&(o.dataset.wired=`1`,o.addEventListener(`click`,()=>{var t;let r=parseInt((t=e.querySelector(`#ao3h-rt-cleanup-days`))==null?void 0:t.value,10);if(!r||r<=0){window.alert(`Enter a number of days first.`);return}let i=Date.now()-r*864e5,a=Kt(),o=a.filter(e=>e.pinned||(e.lastReadAt||e.seenAt||0)>=i),s=a.length-o.length;qt(o),n&&$t(n),window.alert(`Removed ${s} entr${s===1?`y`:`ies`} older than ${r} days (pinned entries kept).`);}));let s=e.querySelector(`[data-action="rt-add-exclusion"]`);s&&!s.dataset.wired&&(s.dataset.wired=`1`,en(),s.addEventListener(`click`,()=>{let t=e.querySelector(`#ao3h-rt-exclude-input`),n=t==null?void 0:t.value.trim();if(!n)return;let r=/^\d+$/.test(n)?n:`fandom:${n}`,i=Jt();i.includes(r)||Yt([...i,r]),t.value=``,en();}));}document.addEventListener(`ao3h:configOpen`,function(e){var t;((t=e.detail)==null?void 0:t.moduleId)===`readingTracker`&&tn(e.target);});var nn=`textToSpeech`,rn=`
...
`,nr=`ao3h:laterShelf:items`,rr=`ao3h:laterShelf:archive`,ir=`ao3h:laterShelf:reminders`,ar=`ao3h:laterShelf:reminders:history`,or=`ao3h:rt:history`,sr=`ao3h:ficAppreciation:status`;function cr(e,t){try{let n=JSON.parse(localStorage.getItem(e)||`null`);return n==null?t:n}catch(e){return t}}function lr(e,t){try{localStorage.setItem(e,JSON.stringify(t));}catch(e){}}function Y(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function ur(){let e=cr(nr,[]);return Array.isArray(e)?e:[]}function dr(e){lr(nr,e);}function fr(){let e=cr(rr,[]);return Array.isArray(e)?e:[]}function pr(e){lr(rr,e);}function mr(){let e=cr(ir,{});return e&&typeof e==`object`?e:{}}function hr(){let e=cr(ar,[]);return Array.isArray(e)?e:[]}function gr(){let e=cr(or,[]);return Array.isArray(e)?e:[]}function _r(){let e=cr(sr,{});return e&&typeof e==`object`?e:{}}function vr(e){let t=ur(),n={};t.forEach(e=>{e.group&&(n[e.group]=(n[e.group]||0)+1);});let r=Object.keys(n).sort();if(!r.length){e.innerHTML=`<p class="ao3h-ls-cfg-empty">No groups yet — assign one from the MFL page.</p>`;return}e.innerHTML=r.map(e=>`
    ...
    </div>`).join(``);}function yr(e){e.addEventListener(`click`,n=>{let r=n.target.closest(`[data-action="ls-rename-group"]`),i=n.target.closest(`[data-action="ls-clear-group"]`);if(r){let n=r.dataset.group,i=window.prompt(`Rename group "${n}" to:`,n);if(i===null||!i.trim()||i.trim()===n)return;dr(ur().map(e=>e.group===n?l(l({},e),{},{group:i.trim()}):e)),vr(e);}else if(i){let n=i.dataset.group;if(!window.confirm(`Remove the "${n}" group from all its fics? (the fics themselves stay on the shelf)`))return;dr(ur().map(e=>e.group===n?l(l({},e),{},{group:``}):e)),vr(e);}});}function br(e){let t=fr();if(!t.length){e.innerHTML=`<p class="ao3h-ls-cfg-empty">No removed fics yet.</p>`;return}e.innerHTML=t.slice(0,50).map(e=>`
    ...
    </div>`).join(``);}function xr(e){e.addEventListener(`click`,n=>{var r;let i=n.target.closest(`[data-action="ls-restore"]`),a=n.target.closest(`[data-action="ls-forget"]`),o=(r=i||a)==null?void 0:r.dataset.wid;if(!o)return;let s=fr(),c=s.findIndex(e=>String(e.wid)===String(o));if(c===-1)return;let[l$1]=s.splice(c,1);if(pr(s),i){let{removedAt:e}=l$1,n=t$1(l$1,$n),r=ur();r.some(e=>String(e.wid)===String(o))||(r.push(l(l({},n),{},{addedAt:Date.now(),order:Date.now()})),dr(r));}br(e);});}var Sr={fired:`🔔 Fired`,cancelled:`✕ Cancelled`,snoozed:`💤 Snoozed`};function Cr(e){let t=hr();if(!t.length){e.innerHTML=`<p class="ao3h-ls-cfg-empty">No reminder activity yet.</p>`;return}e.innerHTML=t.slice(0,50).map(e=>`

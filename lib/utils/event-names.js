 ...
 * _laterShelf.markCurrent), lib/storage/keys.addLaterShelfItem (écrivain
...
/**
 * Un work vient d'être marqué comme terminé. detail: { workId }
 * Émetteur : ficAppreciation (markAsFinished.markFinished)
 * Écouteur : userRelationships/authorPreference (incrémente readCount pour
 * l'auteur du work, lu directement sur la page via lib/ao3/work-page.js)
 */

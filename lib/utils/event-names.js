...
/**
 * Demande d'ouverture du manager Word Swap.
 * ⚠️ Contrat mort : core/coordinator l'émet mais aucun module ne l'écoute
 * (word-swap ouvre son panneau autrement). À brancher ou à supprimer.
 */
export const EV_OPEN_TEXTREPLACER_MANAGER = 'ao3h:open-textreplacer-manager';

/**
 * Un work vient d'être ajouté au Later Shelf. detail: { workId, title?, author? }
 * ⚠️ Contrat mort : _ficDownloader l'écoute (auto-sauvegarde offline du work)
 * mais aucun émetteur n'existe — le bouton 📌 (quickMarkForLaterButton)
 * n'émet pas cet événement. Décision produit : brancher l'émission côté
 * later-shelf, ou retirer l'écouteur.
 */

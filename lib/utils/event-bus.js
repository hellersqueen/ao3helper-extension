...
// Ancré sur globalThis : dans le sandbox userscript, le graphe statique et
// les import() dynamiques peuvent chacun évaluer ce module, ce qui créerait
// deux bus distincts (les événements d'un graphe n'atteindraient pas l'autre).
// On garantit un singleton partagé entre toutes les évaluations.
export const Bus = (globalThis.__AO3H_Bus__ || (globalThis.__AO3H_Bus__ = (()=> {
  const map = new Map();
   ...
   * @param {string|Document|Element} target - Selector or event target (default: document)
   */

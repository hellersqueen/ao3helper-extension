...
export const config = `
                ...
                <div class="ao3h-setting-item ao3h-col2">
                    ...
                    <div class="ao3h-setting-control">
                        <input type="text" class="ao3h-config-input ao3h-field--md" data-setting="sceneBreakStyle" placeholder="✦ ✦ ✦">
                    </div>
                </div>
                ...
                <div class="ao3h-setting-item">
                    ...
                    <div class="ao3h-setting-control">
                        <select class="ao3h-setting-select" data-setting="textAlignment">
                ...
                <div class="ao3h-setting-item">
                    ...
                    <div class="ao3h-setting-control">
                        <input type="text" class="ao3h-config-input" data-setting="paragraphSpacing" placeholder="e.g. 0.5em">
                    </div>

...
export const config = `
                ...
                <div class="ao3h-setting-item">
                    ...
                    <div class="ao3h-setting-control">
                        <input type="number" class="ao3h-config-input" data-setting="delayIn" value="120" min="0" max="2000">
                    </div>
                ...
                <div class="ao3h-setting-item">
                    ...
                    <div class="ao3h-setting-control">
                        <input type="number" class="ao3h-config-input" data-setting="delayOut" value="160" min="0" max="2000">
                    </div>
                ...
                <div class="ao3h-setting-item">
                    ...
                    <div class="ao3h-setting-control">
                        <input type="number" class="ao3h-config-input" data-setting="maxWidth" value="420" min="200" max="800">
                    </div>

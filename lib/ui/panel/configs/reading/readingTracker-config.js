...
export const config = `
                ...
                <div class="ao3h-config-row">
                    ...
                    <input type="number" class="ao3h-config-input ao3h-field--xs" id="ao3h-rt-cleanup-days" placeholder="Days" min="1">
                ...
                <div class="ao3h-setting-item">
                    ...
                    <div class="ao3h-setting-control">
                        <input type="number" class="ao3h-config-input" data-setting="interval" value="30" min="0">
                    </div>
                </div>

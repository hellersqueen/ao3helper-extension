...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   Mirrors the decompress branch of BackupOperations._gzip() — that method is
   a private instance method (not a standalone export) on a class defined in
   _backupAndSync.js, which also calls register() at load time, so it can't
   be imported here either way. Keep this in sync if _gzip() changes.
═══════════════════════════════════════════════════════════════════════════ */

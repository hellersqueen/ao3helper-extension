...
<div class="ao3h-setting-item">
    ...
    <div class="ao3h-setting-control">
        <input type="number" class="ao3h-config-input ao3h-field--sm" data-setting="wordsPerPage" value="275" min="50" max="1000">
    </div>
...
<div class="ao3h-setting-item">
    ...
    <div class="ao3h-setting-control">
        <textarea class="ao3h-config-input ao3h-field--fill" data-setting="customBooks" rows="3" placeholder="One per line, e.g.&#10;My Favorite Doorstopper: 250000" style="resize:vertical;"></textarea>
    </div>
...
<div class="ao3h-setting-item">
    ...
    <div class="ao3h-setting-control ao3h-radio-group">
        ...
        <label>
            ...
            Custom:
            <input type="number"
                   class="ao3h-config-input ao3h-field--xs"
...
<div class="ao3h-setting-item ao3h-col2">
    ...
    <div class="ao3h-setting-control">
        <input type="number" class="ao3h-config-input ao3h-field--sm" data-setting="oneSittingMinutes" value="60" min="5" max="600">
    </div>
</div>
...
<div class="ao3h-setting-item">
    ...
    <div class="ao3h-setting-control">
        <input type="number" class="ao3h-config-input ao3h-field--sm" data-setting="thresholdFlash" value="1000" min="100" max="10000"> words
    </div>
</div>
<div class="ao3h-setting-item">
    <label class="ao3h-setting-label">Short story up to</label>
    <div class="ao3h-setting-control">
        <input type="number" class="ao3h-config-input ao3h-field--sm" data-setting="thresholdShort" value="17500" min="1000" max="100000"> words
    </div>
</div>
<div class="ao3h-setting-item">
    <label class="ao3h-setting-label">Novella up to</label>
    <div class="ao3h-setting-control">
        <input type="number" class="ao3h-config-input ao3h-field--sm" data-setting="thresholdNovella" value="60000" min="1000" max="200000"> words
    </div>
</div>
<div class="ao3h-setting-item">
    <label class="ao3h-setting-label">Novel up to</label>
    <div class="ao3h-setting-control">
        <input type="number" class="ao3h-config-input ao3h-field--sm" data-setting="thresholdEpic" value="150000" min="10000" max="1000000"> words
    </div>

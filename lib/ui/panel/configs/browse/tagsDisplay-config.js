...
// Self-contained, like the rest of this panel: reads/writes the same
// localStorage keys as the autoHideNoiseTags submodule. Shared noise-tag
// detection now lives in lib/utils/noise-tags.js; this panel intentionally
// does not import the runtime module.
import { escapeHtml } from '../../../../utils/dom.js';

const CUSTOM_NOISE_WORDS_KEY  = 'ao3h:tagsDisplay:customNoiseWords';
...
const getCustomNoiseWords  = () => getStoredList(CUSTOM_NOISE_WORDS_KEY);
const saveCustomNoiseWords = (list) => saveStoredList(CUSTOM_NOISE_WORDS_KEY, list);

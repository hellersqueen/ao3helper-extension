...
AO3 Helper - Search Enhancer › Results Sorting

Adds derived engagement badges and client-side sorting controls for AO3 work
listings while preserving a restorable copy of the original result order.

Notes

- Supported modes include kudos ratio, save rate, kudos, hits, and default.
- The selected mode is persisted per page path.
- Shared engagement badges created by other modules are never removed.
...
/* ═══════════════════════════════════════════════════════════════════════════
   FEATURE — SORT SCORES AND ENGAGEMENT BADGES
═══════════════════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════════════════
   FEATURE — SORT TOOLBAR AND RESULT ORDER
═══════════════════════════════════════════════════════════════════════════ */

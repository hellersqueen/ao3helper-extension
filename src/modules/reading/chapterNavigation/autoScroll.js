...
AO3 Helper - Chapter Navigation › Auto Scroll

Provides controlled automatic scrolling on work pages with speed presets,
interaction-aware pausing, and optional next-chapter advancement.

Notes

- Scrolling starts only after the user selects a speed.
- User interaction pauses scrolling until a short inactivity delay passes.
- Controls and automatic advancement are configured by the parent module.
...
// The coordinator calls `setup()` on work pages and `teardown()` on cleanup.

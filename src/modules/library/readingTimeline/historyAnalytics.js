...
AO3 Helper - Reading Timeline › History Analytics

Loads Reading Tracker history, transforms it into date-keyed heatmap data, and
computes aggregate reading statistics.

Notes

- Reading Tracker's runtime API is preferred when available.
- Local storage provides a backward-compatible data fallback.
- Listing-page styles and history dividers are restored during cleanup.
...
export class HistoryAnalytics {
  ...
  /* ═════════════════════════════════════════════════════════════════════════
     FEATURE — HISTORY LOADING AND STATISTICS
  ═════════════════════════════════════════════════════════════════════════ */
  ...
  /* ═════════════════════════════════════════════════════════════════════════
     FEATURE — HISTORY SESSION DIVIDERS
  ═════════════════════════════════════════════════════════════════════════ */
...
// The coordinator constructs this stateful helper and invokes `cleanupDom()`.

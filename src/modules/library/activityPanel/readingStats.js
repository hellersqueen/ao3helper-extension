...
AO3 Helper - Activity Panel › Reading Stats

Provides pure calculations for consecutive reading days and milestone-based
achievement badges from aggregated Activity Panel statistics.

Notes

- The helper performs no storage or DOM access.
- Reading streaks count unique consecutive local calendar dates ending today.
- Achievement calculations are deterministic from the supplied totals.
...
export class ReadingStats {
  ...
  // Pure calculations require no initialization or cleanup.
}

...
AO3 Helper - Bookmark Vault › Note Display

Improves bookmark-note presentation with long-note collapsing, title-hover
previews, and a constrained Markdown renderer.

Notes

- Only AO3-relative and archiveofourown.org Markdown links remain clickable.
- Existing note-collapse markers from Reading Status Tracking are respected.
- Original note HTML is retained and restored during cleanup.
...
/* ═══════════════════════════════════════════════════════════════════════════
   FEATURE — COLLAPSED NOTES AND HOVER PREVIEWS
═══════════════════════════════════════════════════════════════════════════ */

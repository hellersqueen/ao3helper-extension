...
AO3 Helper - Bookmark Vault › Status Indicators

Caches bookmark visibility and notes, decorates matching listing blurbs with
status metadata, and optionally filters results by bookmark presence.

Notes

- Completion badges and progress rings derive from AO3 chapter statistics.
- Bookmark-note previews are limited before being stored in the local cache.
- Cleanup restores blurbs hidden by the status filter.
...
export class StatusIndicators {
      ...
      if (showCompl || showRing) {
        ...
        if (chapStr) {
          ...
          if (showRing) {
            ...
            svg.setAttribute('class', 'ao3h-bv-ring');
  ...
  /* ═══════════════════════════════════════════════════════════════════════
     FEATURE — BOOKMARK STATUS FILTER
  ═══════════════════════════════════════════════════════════════════════ */

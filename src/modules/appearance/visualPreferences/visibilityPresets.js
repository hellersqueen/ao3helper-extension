...
AO3 Helper - Visual Preferences › Visibility Presets

Purpose
    Defines reusable preference combinations for showing all metadata, hiding
    statistics or dates, reducing bias, and creating a cleaner reading view.

Notes
    This submodule only returns preset descriptors and detects matching states.
    The coordinator merges, persists, and applies the selected preset.
...
export class VisibilityPresets {
  ...
  /* ═════════════════════════════════════════════════════════════════════════
     FEATURE — PRESET LOOKUP AND MATCHING
  ═════════════════════════════════════════════════════════════════════════ */
...
// This in-memory catalog allocates no persistent resources and needs no cleanup.

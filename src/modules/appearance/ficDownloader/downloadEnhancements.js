...
AO3 Helper - Fic Downloader › Download Enhancements

Purpose
    Adds format selection, resilient downloads, Kindle and Calibre actions,
    cover generation, per-work listing controls, queues, and series downloads.

Notes
    Download preferences are persisted in localStorage. Network requests,
    delayed work, observers, injected controls, and transient notifications
    are tracked so they can be cancelled or removed during cleanup.
...
export class DownloadEnhancements {
  ...
  /* ═════════════════════════════════════════════════════════════════════════
     FEATURE — CONFIGURATION AND ROUTES
  ═════════════════════════════════════════════════════════════════════════ */
  ...
  /* ═════════════════════════════════════════════════════════════════════════
     FEATURE — WORK PAGE INTEGRATIONS
  ═════════════════════════════════════════════════════════════════════════ */
  ...
  _observeBlurbs () {
    this._observer = observe(document.body, { childList: true, subtree: true }, mutations => {
      let changed = false;

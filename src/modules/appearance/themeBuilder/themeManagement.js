...
AO3 Helper - Theme Builder › Theme Management

Purpose
    Manages built-in and user-created themes, including creation, editing,
    preview, application, deletion, sharing, and JSON import/export.

Notes
    User themes include optional author and description metadata. CSS is
    validated before themes are created, edited, or imported. Preview changes
    are reversible and do not replace the selected active theme.
...
/* ═══════════════════════════════════════════════════════════════════════════
   FEATURE — THEME MANAGEMENT ACTIONS
═══════════════════════════════════════════════════════════════════════════ */
